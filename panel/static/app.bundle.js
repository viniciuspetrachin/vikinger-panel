(() => {
  ...
  var en_US_default = {
    meta: {
      ...
      appSubtitle: "VKP \u2014 Valheim Server Manager (Vikinger Panel)"
    },
    nav: {
      sections: {
        painel: "Panel",
    ...
    common: {
      ...
      toasts: {
        ...
        backupRenamed: 'Backup renamed to "{name}"',
        ...
        modsCheckAllSummary: "Checked {checked} package(s): {updates} update(s) available, {errors} error(s)",
        modsUpdateAllSummary: "Updated {updated} package(s), {failed} failed, {skipped} already up to date",
        modsNoLinkedPackages: "No mods linked to Thunderstore"
      },
      confirm: {
        ...
        updateAllMods: "Update all packages below? The server may need to be restarted.\n\n{packages}",
          ...
          items: [
            {
              ...
              a: "Open the <b>Discord</b> tab in the sidebar. Create a webhook in Discord (channel \u2192 Integrations \u2192 Webhooks), paste the URL, enable Discord, choose events, then <b>Save</b> and <b>Send test</b>. Full guide: see the project docs <code>docs/discord-alerts.md</code>."
            },
            {
              q: "Why did a join alert show a Steam ID?",
              a: "Valheim logs the Steam ID first; the character name appears a few seconds later. The panel waits briefly and caches the name for the next join."
            },
            {
              q: "Which events can I turn on?",
              a: "Server down/up, start/stop/restart, 80% CPU/RAM load, player join/leave, new mod installed, and backup failure."
            }
          ]
        },
        problemas: {
    ...
    dashboard: {
      ...
      connect: {
        ...
        localIp: "Local IP",
        localIpHint: "Same Wi\u2011Fi / LAN \u2014 players at home use this.",
        internetIp: "Internet IP",
        internetIpHint: "Friends outside your network \u2014 needs UDP ports open.",
        portGuideTitle: "How to open ports for internet play",
        portGuideLinux: 'On Linux, allow the firewall: <code class="text-gray-300">sudo ufw allow 2456:2458/udp &amp;&amp; sudo ufw reload</code>',
        portGuideRouter: 'On the router, create <strong class="text-gray-300">Port Forwarding</strong> / Virtual Server / port redirect: UDP <strong class="text-gray-300">2456\u20132458</strong> \u2192 the local address above.',
        portGuideSearch: 'Search the web for <strong class="text-gray-300">port forwarding [your router brand/model]</strong> or <strong class="text-gray-300">abrir porta UDP [marca do roteador]</strong> \u2014 menus differ by vendor.',
        portGuidePassword: "Server password is set on the Server tab. Share the Internet IP with friends only after ports work.",
        hint: "Password is set on the Server tab. Open UDP <strong>2456\u20132458</strong> on your router for external access.",
        panelExposureWarning: "The panel (port <strong>8080</strong>) has no authentication yet. Do not expose it to the internet \u2014 anyone who finds it could change the panel and your server."
      },
      players: {
    ...
    server: {
      settings: {
        ...
        save: "Save Settings",
        saveAndRestart: "Save and Restart",
        envRecreateHint: "Name, password, and public listing require recreating the container to take effect in-game."
      },
      envFields: {
        SERVER_NAME: {
          label: "Server Name",
        ...
        SERVER_PUBLIC: {
          ...
          hint: "When enabled, the server appears in Valheim's public server list."
        },
        SERVER_ARGS: {
      ...
      serverNameColors: {
        preview: "Preview",
        fragment: "Fragment {n}",
        addPart: "Add fragment after this one",
        removePart: "Remove fragment",
        color: "Color",
        noColor: "Default (no tag)",
        hexGold: "Gold (#FFD700)",
        hexOrange: "Orange (#FF6600)",
        hexWhite: "White (#FFFFFF)",
        hexHint: "Hex allows color on one fragment only \u2014 other fragments use the default.",
        colorsUsed: "{count}/2 colors used",
        hint: 'Split the name into fragments (+/\u2212). Quotes (") and < > characters are not allowed \u2014 they break the Valheim server browser. Up to 2 named colors or one hex color. Tags are applied automatically.',
        errors: {
          hexSingleOnly: "Hex color allows only one colored part.",
          maxTwoColors: "At most two different named colors are supported.",
          invalidCharacters: 'The name cannot contain quotes (") or < > characters.',
          unsupportedColor: "Color not supported in the Valheim server browser \u2014 pick another option."
        }
      },
      capacity: {
    ...
    mods: {
      ...
      checkAllUpdates: "Check all for updates",
      updateMod: "Update mod",
      updateAllMods: "Update all mods",
      linkThunderstore: "Link Thunderstore",
      dependencyHint: "BepInEx dependency \u2014 update via the main package (e.g. YamlDotNet.dll)",
    ...
    backups: {
      ...
      filters: {
        search: "Search",
        searchPlaceholder: "Name, world, type...",
        kind: "Type",
        modsLabel: "Mods filter",
        modQuery: "Find by mod",
        modQueryPlaceholder: "e.g. Jotunn or Author/Mod",
      ...
      modals: {
        ...
        rename: {
          title: "Rename backup",
          hint: "Set a friendly name. The ZIP file name stays the same.",
          label: "Display name",
          placeholder: "e.g. Pre-Ashlands update",
          save: "Save name"
        },
        details: {
    ...
    files: {
      ...
      delete: {
        ...
        pluginWarning: "Plugin {plugin} depends on this configuration.",
        recreateWarning: "The server is running \u2014 BepInEx will recreate this file when the plugin loads.",
        pluginDisabledHint: "The linked plugin is disabled, so the file will not be recreated automatically."
      },
      json: {
        beautify: "Format JSON",
        invalid: "Invalid JSON \u2014 fix syntax before saving"
      }
    },
    logs: {
      docker: "Docker",
      ...
      refreshOff: "Off",
      refreshNormal: "Normal (5s)",
      refreshRealtime: "Realtime (1s)",
      refreshOverhead: {
        normal: "~0.5% panel/host overhead (est.)",
        realtime: "~2% panel/host overhead (est.)"
      },
      searchPlaceholder: "Search logs\u2026",
      hideNoise: "Hide noise",
      clearBuffer: "Clear buffer",
      lineCount: "{count} lines in buffer",
    ...
    about: {
      subtitle: "VKP \u2014 web manager for a dockerized Valheim server (Vikinger Panel)",
      fields: {
        version: "Version",
        build: "Build",
        commit: "Commit",
      ...
      serverName: {
        advanced: "Edit full server name",
        advancedHint: "Raw SERVER_NAME as sent to Valheim, including color tags and the optional \u201CPowered by VKP\u201D suffix (Vikinger Panel branding).",
        save: "Save server name"
      },
      credits: {
        valheimDocker: {
    ...
    messages: {
      settings: {
        ...
        desc: "Schedule in-game announcements via RCON (say / showMessage). Uses the bundled ValheimRcon mod.",
        enabled: "Feature enabled",
        rconHint: "RCON unavailable \u2014 messages will not send until ValheimRcon is ready and the server is running."
      },
      list: {
        title: "Messages",
        create: "New message",
        empty: "No automatic messages yet.",
        active: "Active",
        inactive: "Off",
        sendNow: "Send now",
        enable: "Enable",
      ...
      form: {
        ...
        defaultName: "Announcement",
        name: "Name",
        channel: "Channel",
        trigger: "Trigger",
        interval: "Interval",
        intervalSeconds: "Seconds (min. 30)",
        runAt: "Run at",
        dailyTime: "Daily time",
        onlyWhenOnline: "Only send when players are online",
        text: "Message text",
        textPlaceholder: "Welcome to %server_name%! Online: %players_online%",
        tagsHint: "Click a tag to insert:",
        preview: "Preview",
        previewBtn: "Preview"
      },
      channels: {
        say: "Chat (say)",
        showMessage: "On-screen (showMessage)"
      },
      triggers: {
        interval: "Every X seconds",
        once: "Once at date/time",
        daily: "Daily at time",
        on_first_join: "New player welcome",
        on_join: "Every player join"
      },
      intervalPresets: {
        "60": "Every 1 minute",
        "300": "Every 5 minutes",
      ...
      summary: {
        ...
        once: "Once at {at}",
        daily: "Daily at {time}",
        on_first_join: "On first join",
        on_join: "On every join"
      },
      confirmDelete: 'Delete message "{name}"?',
      toasts: {
    ...
    mapPage: {
      title: "World map",
      noWorld: "No active world",
      world: "World",
      activeWorld: "active",
      seed: "Seed",
      empty: "No markers found for this world.",
      emptyPins: "No shared pins yet.",
      hintNoMod: "Optional: install ServerSideMap with marker share to sync shared pins and real fog of war. The base map works without it.",
      markers: "Markers",
      explored: "Explored",
      revealAll: "Show fully explored",
      revealAllHint: "Reveals the whole map disc. Leave off to keep fog of war from ServerSideMap.",
      revealAllHintNoMod: "Reveals the seed-tinted base map. Leave off for a fogged disc (ServerSideMap not required).",
      serverSideMap: "\xB7 ServerSideMap",
      serverSideMapTag: "ServerSideMap",
      installServerSideMap: "Install ServerSideMap",
      openThunderstore: "Thunderstore",
      deletePin: "Delete pin",
      deletePinConfirm: 'Delete pin "{name}" from the shared map?',
      deletePinDone: 'Pin "{name}" deleted',
      deletePinNeedsRestart: "Restart the game server so clients sync the updated pins.",
      zoomIn: "Zoom in",
      zoomOut: "Zoom out",
      zoomReset: "Reset view",
      zoomResetShort: "Reset",
      zoomHint: "Scroll to zoom \xB7 drag to pan \xB7 double-click to reset \xB7 click a pin in the list to focus"
    },
    metricsPage: {
      ranges: {
        "1h": "1h",
      ...
      memory: "Memory %",
      history: "History",
      noData: "No data yet \u2014 samples accumulate while the panel runs.",
      cpuOfLimit: "CPU (of limit)",
      aggregate: "Aggregate (panel+server)"
    },
    consolePage: {
      title: "Console",
      logs: "Logs",
    ...
    alerts: {
      title: "Discord",
      subtitle: "Get Discord notifications for important server events.",
      events: "Events",
      webhookHint: "Paste a channel webhook URL from Discord \u203A Integrations \u203A Webhooks.",
      moreChannels: "More channels (Telegram\u2026)",
      hideMoreChannels: "Hide extra channels",
      serverDown: "Server goes down",
      serverUp: "Server is online",
      serverStarting: "Server will start",
      serverStopping: "Server will shut down",
      serverRestarting: "Server will restart",
      serverHighLoad: "Server at 80% load (CPU/RAM)",
      playerJoin: "Player joins",
      playerLeave: "Player leaves",
      playerFirstJoin: "First-time player joins",
      playerKick: "Player kicked via panel",
      playerBan: "Player banned via panel",
      playerDeath: "Player died",
      playerPvpKill: "Player killed player (PvP)",
      bossDefeated: "Boss defeated",
      raidStarted: "Raid/event started",
      playerChat: "Player chat with prefix",
      modAdded: "New mod added",
      modUpdated: "Mod updated",
      modRemoved: "Mod removed",
      backupScheduledWarning: "\u23F0 Backup scheduled",
      backupScheduledWarningHint: "World backup will run in about 5 minute(s).",
      restartScheduledWarning: "\u23F0 Restart scheduled",
      restartScheduledWarningHint: "Scheduled server restart will run in about 5 minute(s).",
      backupOk: "Backup succeeds",
      backupFail: "Backup fails",
      chatBridge: "Chat bridge (in-game \u2192 Discord)",
      chatPrefix: "Prefix",
      chatPrefixPlaceholder: "@discord",
      chatBridgeHint: "Players type the prefix in chat (e.g. @discord hello) to post the rest to Discord as their name. Chat must appear in server/BepInEx logs.",
      discord: "Discord",
      telegram: "Telegram",
      ...
      test: "Send test",
      saved: "Alerts saved",
      tested: "Test notification sent",
      testFailed: "Test notification failed"
    },
    schedule: {
      title: "Schedule",
      subtitle: "Cron-like automatic tasks.",
      jobs: {
        restart: "Nightly restart",
        backup: "Automatic backup",
        modUpdate: "Mod updates"
      },
      saved: "Schedule saved",
      lastRun: "Last run: {when} ({status})",
      neverRun: "Never run yet",
      cronHint: "Cron format: minute hour day month weekday (e.g. 0 5 * * * = daily at 05:00)."
    }
  };
  ...
  var pt_BR_default = {
    meta: {
      locale: "pt-BR",
      appTitle: "Vikinger Panel",
      appSubtitle: "VKP \u2014 Gerenciador Valheim (Vikinger Panel)"
    },
    nav: {
      sections: {
        painel: "Painel",
    ...
    common: {
      ...
      pagination: {
        prev: "Anterior",
        next: "Pr\xF3xima",
        pageOf: "P\xE1gina {page} de {total}",
      ...
      toasts: {
        ...
        backupRenamed: 'Backup renomeado para "{name}"',
        ...
        modsCheckAllSummary: "Verificados {checked} pacote(s): {updates} atualiza\xE7\xE3o(\xF5es) dispon\xEDvel(eis), {errors} erro(s)",
        modsUpdateAllSummary: "Atualizados {updated} pacote(s), {failed} falha(s), {skipped} j\xE1 atualizados",
        modsNoLinkedPackages: "Nenhum mod vinculado ao Thunderstore"
      },
      confirm: {
        ...
        updateAllMods: "Atualizar todos os pacotes abaixo? O servidor pode precisar ser reiniciado.\n\n{packages}",
    ...
    help: {
      categories: {
        ...
        discord: {
          ...
          items: [
            {
              q: "Como ativo notifica\xE7\xF5es no Discord?",
              a: "Abra a aba <b>Discord</b> na barra lateral. Crie um webhook no Discord (canal \u2192 Integra\xE7\xF5es \u2192 Webhooks), cole a URL, ative o Discord, escolha os eventos, depois <b>Salvar</b> e <b>Enviar teste</b>. Guia completo: <code>docs/discord-alerts.md</code>."
            },
            {
              q: "Por que o alerta de entrada mostrou um Steam ID?",
              a: "O Valheim registra o Steam ID primeiro; o nome do personagem aparece alguns segundos depois. O painel espera um pouco e guarda o nome em cache para a pr\xF3xima entrada."
            },
            {
              q: "Quais eventos posso ativar?",
              a: "Servidor cai/sobe, inicia/desliga/reinicia, 80% de CPU/RAM, jogador entra/sai, mod novo instalado e falha de backup."
            }
          ]
        },
        problemas: {
    ...
    dashboard: {
      ...
      connect: {
        ...
        localIp: "IP Local",
        localIpHint: "Mesma rede Wi\u2011Fi/LAN \u2014 quem est\xE1 em casa usa este.",
        internetIp: "IP Internet",
        internetIpHint: "Amigos fora da sua rede \u2014 precisa liberar as portas UDP.",
        portGuideTitle: "Como liberar acesso pela internet",
        portGuideLinux: 'No Linux, libere o firewall: <code class="text-gray-300">sudo ufw allow 2456:2458/udp &amp;&amp; sudo ufw reload</code>',
        portGuideRouter: 'No roteador, crie <strong class="text-gray-300">Port Forwarding</strong> / Virtual Server / redirecionamento de porta: UDP <strong class="text-gray-300">2456\u20132458</strong> apontando para o endere\xE7o local acima.',
        portGuideSearch: 'Pesquise no Google: <strong class="text-gray-300">port forwarding [marca/modelo do roteador]</strong> ou <strong class="text-gray-300">abrir porta UDP [marca do roteador]</strong> \u2014 cada marca usa um menu diferente.',
        portGuidePassword: "A senha do servidor fica na guia Servidor. S\xF3 compartilhe o IP Internet depois que as portas estiverem ok.",
        hint: "A senha \xE9 definida na guia Servidor. Abra UDP <strong>2456\u20132458</strong> em seu roteador para acesso externo.",
        panelExposureWarning: "O painel (porta <strong>8080</strong>) ainda n\xE3o tem autentica\xE7\xE3o. N\xE3o \xE9 ideal exp\xF4-lo \xE0 internet \u2014 qualquer um que descobrisse o endere\xE7o poderia mexer no painel e no servidor."
      },
      players: {
      ...
      quickControls: {
        ...
        backup: "\u{1F4BE} Backup",
        save: "Salvar",
        saved: "Salvamento do mundo solicitado"
      },
      console: {
      ...
      viewPlayers: "Ver jogadores \u2192",
      cpuHost: "{host}% do host",
      cpuTrend: "Tend\xEAncia de CPU",
      openMetrics: "Abrir M\xE9tricas \u2192"
    },
    server: {
      settings: {
        ...
        envRecreateHint: "Nome, senha e listagem p\xFAblica exigem recriar o container para valer no jogo."
      },
      envFields: {
        SERVER_NAME: {
        ...
        SERVER_PUBLIC: {
          label: "Listagem p\xFAblica",
          hint: "Quando ativado, o servidor aparece na lista p\xFAblica do Valheim."
        },
        SERVER_ARGS: {
      ...
      serverNameColors: {
        ...
        fragment: "Fragmento {n}",
        addPart: "Adicionar fragmento abaixo",
        removePart: "Remover fragmento",
        color: "Cor",
        noColor: "Padr\xE3o (sem tag)",
        hexGold: "Dourado (#FFD700)",
        hexOrange: "Laranja (#FF6600)",
        hexWhite: "Branco (#FFFFFF)",
        hexHint: "Hex permite cor em um fragmento s\xF3 \u2014 os outros usam o padr\xE3o.",
        colorsUsed: "{count}/2 cores usadas",
        hint: 'Divida o nome em fragmentos (+/\u2212). Aspas (") e os caracteres < > n\xE3o s\xE3o permitidos \u2014 quebram a listagem do Valheim. At\xE9 2 cores nomeadas ou uma cor hex. As tags s\xE3o aplicadas automaticamente.',
        errors: {
          hexSingleOnly: "Cor hexadecimal permite apenas uma parte colorida.",
          maxTwoColors: "No m\xE1ximo duas cores nomeadas diferentes.",
          invalidCharacters: 'O nome n\xE3o pode conter aspas (") nem os caracteres < ou >.',
          unsupportedColor: "Cor n\xE3o suportada na listagem do Valheim \u2014 escolha outra op\xE7\xE3o."
        }
      },
      capacity: {
    ...
    mods: {
      installedTitle: "Mods instalados",
      viewCards: "Cards",
      viewList: "Lista",
      list: {
        updateStatus: "Status de atualiza\xE7\xE3o"
      },
      install: {
        title: "Instalar mod",
      ...
      checkAllUpdates: "Verificar todos",
      updateMod: "Atualizar mod",
      updateAllMods: "Atualizar todos",
      linkThunderstore: "Link Thunderstore",
      dependencyHint: "Depend\xEAncia BepInEx \u2014 atualize pelo pacote principal (ex.: YamlDotNet.dll)",
      ...
      status: {
        ...
        dependency: "Depend\xEAncia BepInEx",
    ...
    backups: {
      ...
      filters: {
        search: "Busca",
        searchPlaceholder: "Nome, mundo, tipo...",
        kind: "Tipo",
        modsLabel: "Filtro de mods",
        modQuery: "Buscar por mod",
        modQueryPlaceholder: "ex.: Jotunn ou Author/Mod",
        noMatches: "Nenhum backup corresponde aos filtros atuais.",
        kinds: {
          all: "Todos os tipos",
          auto: "Autom\xE1tico",
      ...
      modals: {
        ...
        rename: {
          title: "Renomear backup",
          hint: "Defina um nome amig\xE1vel. O nome do arquivo ZIP permanece o mesmo.",
          label: "Nome de exibi\xE7\xE3o",
          placeholder: "ex.: Antes da atualiza\xE7\xE3o Ashlands",
          save: "Salvar nome"
        },
        details: {
    ...
    files: {
      ...
      delete: {
        ...
        confirm: "Tem certeza que deseja apagar {path}?",
        pluginWarning: "O plugin {plugin} depende desta configura\xE7\xE3o.",
        recreateWarning: "O servidor est\xE1 em execu\xE7\xE3o \u2014 o BepInEx recriar\xE1 este arquivo quando o plugin carregar.",
        pluginDisabledHint: "O plugin vinculado est\xE1 desativado, ent\xE3o o arquivo n\xE3o ser\xE1 recriado automaticamente."
      },
      json: {
        beautify: "Formatar JSON",
        invalid: "JSON inv\xE1lido \u2014 corrija a sintaxe antes de salvar"
      }
    },
    logs: {
      docker: "Docker",
      ...
      refreshLabel: "Atualiza\xE7\xE3o autom\xE1tica",
      refreshOff: "Desligado",
      refreshNormal: "Normal (5s)",
      refreshRealtime: "Tempo real (1s)",
      refreshOverhead: {
        normal: "~0,5% de overhead no painel/host (est.)",
        realtime: "~2% de overhead no painel/host (est.)"
      },
      searchPlaceholder: "Buscar nos logs\u2026",
      hideNoise: "Ocultar ru\xEDdo",
      clearBuffer: "Limpar buffer",
      lineCount: "{count} linhas no buffer",
      matchCount: "{count} correspond\xEAncias",
      categories: {
        all: "Tudo",
        game: "Jogo",
        chat: "Chat",
    ...
    about: {
      subtitle: "VKP \u2014 gerenciador web para servidor Valheim em Docker (Vikinger Panel)",
      fields: {
        version: "Vers\xE3o",
        build: "Construir",
      ...
      serverName: {
        advanced: "Editar nome completo do servidor",
        advancedHint: "SERVER_NAME bruto enviado ao Valheim, incluindo tags de cor e o sufixo opcional \u201CPowered by VKP\u201D (marca do Vikinger Panel).",
        save: "Salvar nome"
      },
      credits: {
        valheimDocker: {
    ...
    messages: {
      settings: {
        title: "Mensagens autom\xE1ticas",
        desc: "Agende an\xFAncios no jogo via RCON (say / showMessage). Usa o mod ValheimRcon j\xE1 embutido.",
        enabled: "Recurso ativo",
        rconHint: "RCON indispon\xEDvel \u2014 as mensagens n\xE3o ser\xE3o enviadas at\xE9 o ValheimRcon estar pronto e o servidor rodando."
      },
      list: {
        title: "Mensagens",
        create: "Nova mensagem",
        empty: "Nenhuma mensagem autom\xE1tica ainda.",
        active: "Ativa",
        inactive: "Desligada",
      ...
      form: {
        createTitle: "Nova mensagem",
        editTitle: "Editar mensagem",
        defaultName: "An\xFAncio",
        name: "Nome",
        channel: "Canal",
        trigger: "Disparo",
        interval: "Intervalo",
        intervalSeconds: "Segundos (m\xEDn. 30)",
        runAt: "Executar em",
        dailyTime: "Hor\xE1rio di\xE1rio",
        onlyWhenOnline: "Enviar apenas com jogadores online",
        text: "Texto da mensagem",
        textPlaceholder: "Bem-vindo a %server_name%! Online: %players_online%",
        tagsHint: "Clique em uma tag para inserir:",
        preview: "Pr\xE9via",
        previewBtn: "Pr\xE9via"
      },
      channels: {
        say: "Chat (say)",
        showMessage: "Na tela (showMessage)"
      },
      triggers: {
        interval: "A cada X segundos",
        once: "Uma vez em data/hora",
        daily: "Todo dia no hor\xE1rio",
        on_first_join: "Boas-vindas (primeiro join)",
        on_join: "Toda entrada de jogador"
      },
      intervalPresets: {
        "60": "A cada 1 minuto",
        "300": "A cada 5 minutos",
        "900": "A cada 15 minutos",
      ...
      summary: {
        ...
        once: "Uma vez em {at}",
        daily: "Di\xE1rio \xE0s {time}",
        on_first_join: "No primeiro join",
        on_join: "Em toda entrada"
      },
      confirmDelete: 'Excluir a mensagem "{name}"?',
      toasts: {
        settingsSaved: "Configura\xE7\xF5es de mensagens salvas",
        created: "Mensagem criada",
        updated: "Mensagem atualizada",
        deleted: "Mensagem exclu\xEDda",
        sent: "Enviado: {text}",
        textRequired: "O texto da mensagem \xE9 obrigat\xF3rio"
      }
    },
    theme: {
      dark: "Tema escuro",
    ...
    playersPage: {
      ...
      biome: "Bioma",
      role: "Fun\xE7\xE3o",
      actionsCol: "A\xE7\xF5es",
      player: "Jogador"
    },
    mapPage: {
      title: "Mapa do mundo",
      noWorld: "Nenhum mundo ativo",
      world: "Mundo",
      activeWorld: "ativo",
      seed: "Seed",
      empty: "Nenhum marcador encontrado para este mundo.",
      emptyPins: "Nenhum pin compartilhado ainda.",
      hintNoMod: "Opcional: instale o ServerSideMap com compartilhamento de marcadores para sincronizar pins e fog reais. O mapa base funciona sem o mod.",
      markers: "Marcadores",
      explored: "Explorado",
      revealAll: "Mostrar totalmente explorado",
      revealAllHint: "Revela o disco inteiro do mapa. Desligado mant\xE9m o fog of war do ServerSideMap.",
      revealAllHintNoMod: "Revela o mapa base tintado pela seed. Desligado mant\xE9m o disco com n\xE9voa (ServerSideMap n\xE3o \xE9 obrigat\xF3rio).",
      serverSideMap: "\xB7 ServerSideMap",
      serverSideMapTag: "ServerSideMap",
      installServerSideMap: "Instalar ServerSideMap",
      openThunderstore: "Thunderstore",
      deletePin: "Apagar pin",
      deletePinConfirm: 'Apagar o pin "{name}" do mapa compartilhado?',
      deletePinDone: 'Pin "{name}" apagado',
      deletePinNeedsRestart: "Reinicie o servidor do jogo para os clientes sincronizarem os pins.",
      zoomIn: "Aumentar zoom",
      zoomOut: "Diminuir zoom",
      zoomReset: "Resetar vis\xE3o",
      zoomResetShort: "Reset",
      zoomHint: "Scroll para zoom \xB7 arraste para mover \xB7 duplo clique para resetar \xB7 clique num pin da lista para focar"
    },
    metricsPage: {
      ranges: {
        "1h": "1h",
      ...
      noData: "Ainda sem dados \u2014 as amostras acumulam enquanto o painel roda.",
      cpuOfLimit: "CPU (do limite)",
      aggregate: "Agregado (painel+servidor)"
    },
    consolePage: {
      title: "Console",
      logs: "Logs",
      history: "Hist\xF3rico de comandos",
      quick: {
        save: "Salvar",
        saveShutdown: "Salvar e desligar",
        kick: "Expulsar",
        ban: "Banir",
        broadcast: "Anunciar"
      }
    ...
    alerts: {
      title: "Discord",
      subtitle: "Receba notifica\xE7\xF5es no Discord sobre eventos importantes do servidor.",
      events: "Eventos",
      webhookHint: "Cole a URL do webhook em Discord \u203A Integra\xE7\xF5es \u203A Webhooks.",
      moreChannels: "Mais canais (Telegram\u2026)",
      hideMoreChannels: "Ocultar canais extras",
      serverDown: "Servidor cai",
      serverUp: "Servidor online",
      serverStarting: "Servidor ser\xE1 iniciado",
      serverStopping: "Servidor ser\xE1 desligado",
      serverRestarting: "Servidor ser\xE1 reiniciado",
      serverHighLoad: "Servidor com 80% de carga (CPU/RAM)",
      playerJoin: "Jogador entra",
      playerLeave: "Jogador sai",
      playerFirstJoin: "Primeiro join de jogador novo",
      playerKick: "Kick via painel",
      playerBan: "Ban via painel",
      playerDeath: "Player morreu",
      playerPvpKill: "Player matou player (PvP)",
      bossDefeated: "Boss derrotado",
      raidStarted: "Raid/evento iniciado",
      playerChat: "Chat do jogador com prefixo",
      modAdded: "Mod novo adicionado",
      modUpdated: "Mod atualizado",
      modRemoved: "Mod removido",
      backupScheduledWarning: "\u23F0 Backup agendado",
      backupScheduledWarningHint: "O backup do mundo rodar\xE1 em cerca de 5 minuto(s).",
      restartScheduledWarning: "\u23F0 Restart agendado",
      restartScheduledWarningHint: "O restart agendado do servidor rodar\xE1 em cerca de 5 minuto(s).",
      backupOk: "Backup bem-sucedido",
      backupFail: "Backup falha",
      chatBridge: "Bridge de chat (jogo \u2192 Discord)",
      chatPrefix: "Prefixo",
      chatPrefixPlaceholder: "@discord",
      chatBridgeHint: "Jogadores digitam o prefixo no chat (ex.: @discord ol\xE1) para enviar o resto ao Discord com o nome deles. O chat precisa aparecer nos logs do servidor/BepInEx.",
      discord: "Discord",
      telegram: "Telegram",
      webhookPlaceholder: "URL do webhook do Discord",
      botTokenPlaceholder: "Token do bot do Telegram",
      chatIdPlaceholder: "Chat ID do Telegram",
      secretSet: "\u2022\u2022\u2022\u2022\u2022\u2022 (salvo)",
      showSecret: "Mostrar",
      hideSecret: "Ocultar",
      test: "Enviar teste",
      saved: "Alertas salvos",
      tested: "Notifica\xE7\xE3o de teste enviada",
      testFailed: "Falha ao enviar notifica\xE7\xE3o de teste"
    },
    schedule: {
      title: "Agendamento",
      subtitle: "Tarefas autom\xE1ticas no estilo cron.",
      jobs: {
        restart: "Rein\xEDcio noturno",
        backup: "Backup autom\xE1tico",
        modUpdate: "Atualiza\xE7\xE3o de mods"
      },
      saved: "Agendamento salvo",
      lastRun: "\xDAltima execu\xE7\xE3o: {when} ({status})",
      neverRun: "Nunca executado",
      cronHint: "Formato cron: minuto hora dia m\xEAs dia-da-semana (ex.: 0 5 * * * = di\xE1rio \xE0s 05:00)."
    }
  };
  ...
  var de_DE_default = {
    ...
    common: {
      ...
      toasts: {
        ...
        modsCheckAllSummary: "{checked} Paket(e) gepr\xFCft: {updates} Update(s) verf\xFCgbar, {errors} Fehler",
        modsUpdateAllSummary: "{updated} Paket(e) aktualisiert, {failed} fehlgeschlagen, {skipped} bereits aktuell",
        modsNoLinkedPackages: "Keine Mods mit Thunderstore-Verkn\xFCpfung"
      },
      confirm: {
        ...
        updateAllMods: "Alle Pakete unten aktualisieren? M\xF6glicherweise muss der Server neu gestartet werden.\n\n{packages}",
    ...
    help: {
      categories: {
        ...
        discord: {
          label: "Discord-Benachrichtigungen",
          items: [
            {
              q: "Wie aktiviere ich Discord-Benachrichtigungen?",
              a: "\xD6ffne den Tab <b>Discord</b> in der Seitenleiste. Erstelle einen Webhook in Discord (Kanal \u2192 Integrationen \u2192 Webhooks), f\xFCge die URL ein, aktiviere Discord, w\xE4hle Ereignisse, dann <b>Speichern</b> und <b>Test senden</b>. Anleitung: <code>docs/discord-alerts.md</code>."
            },
            {
              q: "Warum zeigte eine Beitrittsmeldung eine Steam-ID?",
              a: "Valheim loggt zuerst die Steam-ID; der Charaktername erscheint etwas sp\xE4ter. Das Panel wartet kurz und speichert den Namen f\xFCr den n\xE4chsten Beitritt."
            },
            {
              q: "Welche Ereignisse kann ich aktivieren?",
              a: "Server offline/online, Start/Stopp/Neustart, 80% CPU/RAM, Spieler tritt bei/verl\xE4sst, neuer Mod, Backup-Fehler."
            }
          ]
        },
        problemas: {
    ...
    dashboard: {
      ...
      connect: {
        ...
        localIp: "Lokale IP",
        localIpHint: "Gleiches WLAN / LAN \u2014 Spieler zu Hause nutzen diese.",
        internetIp: "Internet-IP",
        internetIpHint: "Freunde au\xDFerhalb Ihres Netzes \u2014 UDP-Ports m\xFCssen offen sein.",
        portGuideTitle: "Ports f\xFCr Internetzugriff \xF6ffnen",
        portGuideLinux: 'Unter Linux Firewall freigeben: <code class="text-gray-300">sudo ufw allow 2456:2458/udp &amp;&amp; sudo ufw reload</code>',
        portGuideRouter: 'Am Router <strong class="text-gray-300">Port Forwarding</strong> / Virtual Server / Portumleitung anlegen: UDP <strong class="text-gray-300">2456\u20132458</strong> \u2192 die lokale Adresse oben.',
        portGuideSearch: 'Suchen Sie online nach <strong class="text-gray-300">port forwarding [Router-Marke/Modell]</strong> \u2014 die Men\xFCs unterscheiden sich je Hersteller.',
        portGuidePassword: "Das Serverpasswort steht unter \u201EServer\u201C. Teilen Sie die Internet-IP erst, wenn die Ports funktionieren.",
        ...
        panelExposureWarning: "Das Panel (Port <strong>8080</strong>) hat noch keine Authentifizierung. Es ist nicht ratsam, es im Internet freizugeben \u2014 wer die Adresse findet, k\xF6nnte Panel und Server \xE4ndern."
      },
      players: {
      ...
      quickControls: {
        ...
        save: "Speichern",
        saved: "Welt-Speicherung angefordert"
      },
      console: {
      ...
      viewPlayers: "Spieler anzeigen \u2192",
      cpuHost: "{host}% des Hosts",
      cpuTrend: "CPU-Verlauf",
      openMetrics: "Metriken \xF6ffnen \u2192"
    },
    server: {
      settings: {
        ...
        saveAndRestart: "Speichern und neu starten",
        envRecreateHint: "Name, Passwort und \xF6ffentliche Listung erfordern eine Neuerstellung des Containers, um im Spiel zu gelten."
      },
      envFields: {
        SERVER_NAME: {
          label: "Servername",
        ...
        SERVER_PUBLIC: {
          label: "\xD6ffentliche Listung",
          hint: "Wenn aktiviert, erscheint der Server in der \xF6ffentlichen Valheim-Serverliste."
        },
        SERVER_ARGS: {
    ...
    mods: {
      ...
      checkAllUpdates: "Alle auf Updates pr\xFCfen",
      updateMod: "Mod aktualisieren",
      updateAllMods: "Alle Mods aktualisieren",
      linkThunderstore: "Link Thunderstore",
      dependencyHint: "BepInEx-Abh\xE4ngigkeit \u2014 \xFCber das Hauptpaket aktualisieren (z. B. YamlDotNet.dll)",
      linkUrlPlaceholder: "Thunderstore-URL",
      configBtn: "Konfig",
      remove: "Entfernen",
      ...
      status: {
        ...
        dependency: "BepInEx-Abh\xE4ngigkeit",
    ...
    files: {
      ...
      delete: {
        ...
        confirm: "M\xF6chten Sie {path} wirklich l\xF6schen?",
        pluginWarning: "Plugin {plugin} h\xE4ngt von dieser Konfiguration ab.",
        recreateWarning: "Der Server l\xE4uft \u2014 BepInEx erstellt diese Datei neu, wenn das Plugin geladen wird.",
        pluginDisabledHint: "Das verkn\xFCpfte Plugin ist deaktiviert; die Datei wird nicht automatisch neu erstellt."
      },
      json: {
        beautify: "JSON formatieren",
        invalid: "Ung\xFCltiges JSON \u2014 Syntax vor dem Speichern korrigieren"
      }
    },
    logs: {
      docker: "Docker",
      ...
      refreshLabel: "Auto-Aktualisierung",
      refreshOff: "Aus",
      refreshNormal: "Normal (5s)",
      refreshRealtime: "Echtzeit (1s)",
      refreshOverhead: {
        normal: "~0,5 % Panel/Host-Overhead (gesch\xE4tzt)",
        realtime: "~2 % Panel/Host-Overhead (gesch\xE4tzt)"
      },
      searchPlaceholder: "Logs durchsuchen\u2026",
      hideNoise: "Rauschen ausblenden",
      clearBuffer: "Puffer leeren",
      lineCount: "{count} Zeilen im Puffer",
    ...
    about: {
      ...
      serverName: {
        advanced: "Vollst\xE4ndigen Servernamen bearbeiten",
        save: "Servernamen speichern"
      },
      credits: {
        valheimDocker: {
          label: "Valheim-Server in Docker",
    ...
    messages: {
      settings: {
        ...
        desc: "Plane Ingame-Ank\xFCndigungen \xFCber RCON (say / showMessage). Nutzt das mitgelieferte ValheimRcon-Mod.",
        enabled: "Funktion aktiv",
        rconHint: "RCON nicht verf\xFCgbar \u2014 Nachrichten werden erst gesendet, wenn ValheimRcon bereit und der Server l\xE4uft."
      },
      list: {
        title: "Nachrichten",
        create: "Neue Nachricht",
        empty: "Noch keine automatischen Nachrichten.",
        active: "Aktiv",
        inactive: "Aus",
      ...
      form: {
        createTitle: "Neue Nachricht",
        editTitle: "Nachricht bearbeiten",
        defaultName: "Ank\xFCndigung",
        name: "Name",
        channel: "Kanal",
        trigger: "Ausl\xF6ser",
        interval: "Intervall",
        intervalSeconds: "Sekunden (min. 30)",
        runAt: "Ausf\xFChren um",
        dailyTime: "T\xE4gliche Uhrzeit",
        onlyWhenOnline: "Nur senden, wenn Spieler online sind",
        text: "Nachrichtentext",
        textPlaceholder: "Willkommen auf %server_name%! Online: %players_online%",
        tagsHint: "Klicke auf ein Tag zum Einf\xFCgen:",
        preview: "Vorschau",
        previewBtn: "Vorschau"
      },
      channels: {
        say: "Chat (say)",
        showMessage: "Bildschirm (showMessage)"
      },
      triggers: {
        interval: "Alle X Sekunden",
        once: "Einmal zu Datum/Uhrzeit",
        daily: "T\xE4glich zur Uhrzeit",
        on_first_join: "Willkommen (erster Join)",
        on_join: "Bei jedem Spielerbeitritt"
      },
      intervalPresets: {
        "60": "Jede Minute",
        "300": "Alle 5 Minuten",
      ...
      summary: {
        interval: "Alle {seconds}s",
        once: "Einmal um {at}",
        daily: "T\xE4glich um {time}",
        on_first_join: "Beim ersten Join",
        on_join: "Bei jedem Join"
      },
      confirmDelete: 'Nachricht "{name}" l\xF6schen?',
      toasts: {
        settingsSaved: "Nachrichteneinstellungen gespeichert",
        created: "Nachricht erstellt",
        updated: "Nachricht aktualisiert",
        deleted: "Nachricht gel\xF6scht",
        sent: "Gesendet: {text}",
        textRequired: "Nachrichtentext ist erforderlich"
      }
    },
    theme: {
      dark: "Dunkles Design",
    ...
    mapPage: {
      title: "Weltkarte",
      noWorld: "Keine aktive Welt",
      world: "Welt",
      activeWorld: "aktiv",
      seed: "Seed",
      empty: "Keine Marker f\xFCr diese Welt gefunden.",
      emptyPins: "Noch keine geteilten Pins.",
      hintNoMod: "Optional: ServerSideMap mit Marker-Share installieren f\xFCr geteilte Pins und echten Nebel. Die Basiskarte funktioniert ohne den Mod.",
      markers: "Marker",
      explored: "Erkundet",
      revealAll: "Vollst\xE4ndig erkundet anzeigen",
      revealAllHint: "Zeigt die gesamte Karte. Aus = Nebel des Krieges von ServerSideMap.",
      revealAllHintNoMod: "Zeigt die seed-get\xF6nte Basiskarte. Aus = vernebelte Scheibe (ServerSideMap nicht n\xF6tig).",
      serverSideMap: "\xB7 ServerSideMap",
      serverSideMapTag: "ServerSideMap",
      installServerSideMap: "ServerSideMap installieren",
      openThunderstore: "Thunderstore",
      deletePin: "Pin l\xF6schen",
      deletePinConfirm: 'Pin "{name}" von der geteilten Karte l\xF6schen?',
      deletePinDone: 'Pin "{name}" gel\xF6scht',
      deletePinNeedsRestart: "Starte den Spielserver neu, damit Clients die Pins synchronisieren.",
      zoomIn: "Vergr\xF6\xDFern",
      zoomOut: "Verkleinern",
      zoomReset: "Ansicht zur\xFCcksetzen",
      zoomResetShort: "Reset",
      zoomHint: "Scrollen zum Zoomen \xB7 Ziehen zum Verschieben \xB7 Doppelklick zum Zur\xFCcksetzen \xB7 Pin in der Liste anklicken zum Fokussieren"
    },
    metricsPage: {
      ranges: {
        "1h": "1 Std",
      ...
      memory: "Speicher %",
      history: "Verlauf",
      noData: "Noch keine Daten \u2014 Proben sammeln sich, w\xE4hrend das Panel l\xE4uft.",
      cpuOfLimit: "CPU (vom Limit)",
      aggregate: "Gesamt (Panel+Server)"
    },
    consolePage: {
      title: "Konsole",
      logs: "Logs",
      ...
      quick: {
        save: "Speichern",
        saveShutdown: "Speichern & herunterfahren",
        kick: "Kicken",
        ban: "Bannen",
        broadcast: "Ansage"
      }
    ...
    alerts: {
      title: "Discord",
      subtitle: "Erhalte Discord-Benachrichtigungen zu wichtigen Serverereignissen.",
      events: "Ereignisse",
      webhookHint: "Webhook-URL aus Discord \u203A Integrationen \u203A Webhooks einf\xFCgen.",
      moreChannels: "Weitere Kan\xE4le (Telegram\u2026)",
      hideMoreChannels: "Zus\xE4tzliche Kan\xE4le ausblenden",
      serverDown: "Server f\xE4llt aus",
      serverUp: "Server ist online",
      serverStarting: "Server wird gestartet",
      serverStopping: "Server wird heruntergefahren",
      serverRestarting: "Server wird neu gestartet",
      serverHighLoad: "Server bei 80% Last (CPU/RAM)",
      playerJoin: "Spieler tritt bei",
      playerLeave: "Spieler verl\xE4sst",
      playerFirstJoin: "Erstes Mal auf dem Server",
      playerKick: "Kick \xFCber das Panel",
      playerBan: "Ban \xFCber das Panel",
      playerDeath: "Spieler gestorben",
      playerPvpKill: "Spieler t\xF6tet Spieler (PvP)",
      bossDefeated: "Boss besiegt",
      raidStarted: "Raid/Event gestartet",
      playerChat: "Spieler-Chat mit Pr\xE4fix",
      modAdded: "Neuer Mod hinzugef\xFCgt",
      modUpdated: "Mod aktualisiert",
      modRemoved: "Mod entfernt",
      backupScheduledWarning: "\u23F0 Backup geplant",
      backupScheduledWarningHint: "Welt-Backup startet in etwa 5 Minute(n).",
      restartScheduledWarning: "\u23F0 Neustart geplant",
      restartScheduledWarningHint: "Geplanter Server-Neustart in etwa 5 Minute(n).",
      backupOk: "Backup erfolgreich",
      backupFail: "Backup schl\xE4gt fehl",
      chatBridge: "Chat-Bridge (Spiel \u2192 Discord)",
      chatPrefix: "Pr\xE4fix",
      chatPrefixPlaceholder: "@discord",
      chatBridgeHint: "Spieler tippen das Pr\xE4fix im Chat (z. B. @discord hallo), um den Rest als ihren Namen an Discord zu senden. Chat muss in Server-/BepInEx-Logs erscheinen.",
      discord: "Discord",
      telegram: "Telegram",
      webhookPlaceholder: "Discord-Webhook-URL",
      botTokenPlaceholder: "Telegram-Bot-Token",
      ...
      showSecret: "Anzeigen",
      hideSecret: "Verbergen",
      test: "Test senden",
      saved: "Benachrichtigungen gespeichert",
      tested: "Testbenachrichtigung gesendet",
      testFailed: "Testbenachrichtigung fehlgeschlagen"
    },
    schedule: {
      title: "Zeitplan",
      subtitle: "Cron-\xE4hnliche automatische Aufgaben.",
      jobs: {
        restart: "N\xE4chtlicher Neustart",
        backup: "Automatisches Backup",
        modUpdate: "Mod-Updates"
      },
      saved: "Zeitplan gespeichert",
      lastRun: "Letzte Ausf\xFChrung: {when} ({status})",
      neverRun: "Noch nie ausgef\xFChrt",
      cronHint: "Cron-Format: Minute Stunde Tag Monat Wochentag (z. B. 0 5 * * * = t\xE4glich um 05:00)."
    }
  };
  ...
  var ru_RU_default = {
    ...
    common: {
      ...
      toasts: {
        ...
        modsCheckAllSummary: "\u041F\u0440\u043E\u0432\u0435\u0440\u0435\u043D\u043E \u043F\u0430\u043A\u0435\u0442\u043E\u0432: {checked}, \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u043E \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u0439: {updates}, \u043E\u0448\u0438\u0431\u043E\u043A: {errors}",
        modsUpdateAllSummary: "\u041E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u043E: {updated}, \u043E\u0448\u0438\u0431\u043E\u043A: {failed}, \u0443\u0436\u0435 \u0430\u043A\u0442\u0443\u0430\u043B\u044C\u043D\u043E: {skipped}",
        modsNoLinkedPackages: "\u041D\u0435\u0442 \u043C\u043E\u0434\u043E\u0432, \u0441\u0432\u044F\u0437\u0430\u043D\u043D\u044B\u0445 \u0441 Thunderstore"
      },
      confirm: {
        ...
        updateAllMods: "\u041E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0432\u0441\u0435 \u043F\u0430\u043A\u0435\u0442\u044B \u043D\u0438\u0436\u0435? \u0412\u043E\u0437\u043C\u043E\u0436\u043D\u043E, \u043F\u043E\u0442\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044F \u043F\u0435\u0440\u0435\u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0441\u0435\u0440\u0432\u0435\u0440.\n\n{packages}",
    ...
    help: {
      categories: {
        ...
        discord: {
          label: "\u041E\u043F\u043E\u0432\u0435\u0449\u0435\u043D\u0438\u044F Discord",
          items: [
            {
              q: "\u041A\u0430\u043A \u0432\u043A\u043B\u044E\u0447\u0438\u0442\u044C \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F Discord?",
              a: "\u041E\u0442\u043A\u0440\u043E\u0439\u0442\u0435 \u0432\u043A\u043B\u0430\u0434\u043A\u0443 <b>Discord</b> \u0432 \u0431\u043E\u043A\u043E\u0432\u043E\u0439 \u043F\u0430\u043D\u0435\u043B\u0438. \u0421\u043E\u0437\u0434\u0430\u0439\u0442\u0435 \u0432\u0435\u0431\u0445\u0443\u043A \u0432 Discord (\u043A\u0430\u043D\u0430\u043B \u2192 \u0418\u043D\u0442\u0435\u0433\u0440\u0430\u0446\u0438\u0438 \u2192 \u0412\u0435\u0431\u0445\u0443\u043A\u0438), \u0432\u0441\u0442\u0430\u0432\u044C\u0442\u0435 URL, \u0432\u043A\u043B\u044E\u0447\u0438\u0442\u0435 Discord, \u0432\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0441\u043E\u0431\u044B\u0442\u0438\u044F, \u0437\u0430\u0442\u0435\u043C <b>\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C</b> \u0438 <b>\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0442\u0435\u0441\u0442</b>. \u0413\u0430\u0439\u0434: <code>docs/discord-alerts.md</code>."
            },
            {
              q: "\u041F\u043E\u0447\u0435\u043C\u0443 \u0432 \u043E\u043F\u043E\u0432\u0435\u0449\u0435\u043D\u0438\u0438 \u043E \u0432\u0445\u043E\u0434\u0435 \u0431\u044B\u043B Steam ID?",
              a: "Valheim \u0441\u043D\u0430\u0447\u0430\u043B\u0430 \u043F\u0438\u0448\u0435\u0442 Steam ID; \u0438\u043C\u044F \u043F\u0435\u0440\u0441\u043E\u043D\u0430\u0436\u0430 \u043F\u043E\u044F\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u0447\u0443\u0442\u044C \u043F\u043E\u0437\u0436\u0435. \u041F\u0430\u043D\u0435\u043B\u044C \u043A\u043E\u0440\u043E\u0442\u043A\u043E \u0436\u0434\u0451\u0442 \u0438 \u043A\u044D\u0448\u0438\u0440\u0443\u0435\u0442 \u0438\u043C\u044F \u0434\u043B\u044F \u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0433\u043E \u0432\u0445\u043E\u0434\u0430."
            },
            {
              q: "\u041A\u0430\u043A\u0438\u0435 \u0441\u043E\u0431\u044B\u0442\u0438\u044F \u043C\u043E\u0436\u043D\u043E \u0432\u043A\u043B\u044E\u0447\u0438\u0442\u044C?",
              a: "\u0421\u0435\u0440\u0432\u0435\u0440 \u0443\u043F\u0430\u043B/\u043F\u043E\u0434\u043D\u044F\u043B\u0441\u044F, \u0441\u0442\u0430\u0440\u0442/\u0441\u0442\u043E\u043F/\u0440\u0435\u0441\u0442\u0430\u0440\u0442, 80% CPU/RAM, \u0438\u0433\u0440\u043E\u043A \u0432\u043E\u0448\u0451\u043B/\u0432\u044B\u0448\u0435\u043B, \u043D\u043E\u0432\u044B\u0439 \u043C\u043E\u0434 \u0438 \u043E\u0448\u0438\u0431\u043A\u0430 \u0431\u044D\u043A\u0430\u043F\u0430."
            }
          ]
        },
        problemas: {
    ...
    dashboard: {
      ...
      connect: {
        ...
        localIpHint: "\u0422\u0430 \u0436\u0435 Wi\u2011Fi/LAN \u2014 \u0434\u043B\u044F \u0438\u0433\u0440\u043E\u043A\u043E\u0432 \u0434\u043E\u043C\u0430.",
        internetIp: "\u0418\u043D\u0442\u0435\u0440\u043D\u0435\u0442 IP",
        internetIpHint: "\u0414\u0440\u0443\u0437\u044C\u044F \u0432\u043D\u0435 \u0432\u0430\u0448\u0435\u0439 \u0441\u0435\u0442\u0438 \u2014 \u043D\u0443\u0436\u043D\u043E \u043E\u0442\u043A\u0440\u044B\u0442\u044C UDP-\u043F\u043E\u0440\u0442\u044B.",
        portGuideTitle: "\u041A\u0430\u043A \u043E\u0442\u043A\u0440\u044B\u0442\u044C \u043F\u043E\u0440\u0442\u044B \u0434\u043B\u044F \u0438\u0433\u0440\u044B \u0447\u0435\u0440\u0435\u0437 \u0438\u043D\u0442\u0435\u0440\u043D\u0435\u0442",
        portGuideLinux: '\u0412 Linux \u0440\u0430\u0437\u0440\u0435\u0448\u0438\u0442\u0435 \u0432 \u0444\u0430\u0435\u0440\u0432\u043E\u043B\u0435: <code class="text-gray-300">sudo ufw allow 2456:2458/udp &amp;&amp; sudo ufw reload</code>',
        portGuideRouter: '\u041D\u0430 \u0440\u043E\u0443\u0442\u0435\u0440\u0435 \u0441\u043E\u0437\u0434\u0430\u0439\u0442\u0435 <strong class="text-gray-300">Port Forwarding</strong> / Virtual Server / \u043F\u0435\u0440\u0435\u0430\u0434\u0440\u0435\u0441\u0430\u0446\u0438\u044E \u043F\u043E\u0440\u0442\u043E\u0432: UDP <strong class="text-gray-300">2456\u20132458</strong> \u2192 \u043D\u0430 \u043B\u043E\u043A\u0430\u043B\u044C\u043D\u044B\u0439 \u0430\u0434\u0440\u0435\u0441 \u0432\u044B\u0448\u0435.',
        portGuideSearch: '\u0418\u0449\u0438\u0442\u0435 \u0432 Google: <strong class="text-gray-300">port forwarding [\u0431\u0440\u0435\u043D\u0434/\u043C\u043E\u0434\u0435\u043B\u044C \u0440\u043E\u0443\u0442\u0435\u0440\u0430]</strong> \u2014 \u043C\u0435\u043D\u044E \u0443 \u043A\u0430\u0436\u0434\u043E\u0433\u043E \u043F\u0440\u043E\u0438\u0437\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044F \u0441\u0432\u043E\u0451.',
        portGuidePassword: "\u041F\u0430\u0440\u043E\u043B\u044C \u0441\u0435\u0440\u0432\u0435\u0440\u0430 \u0437\u0430\u0434\u0430\u0451\u0442\u0441\u044F \u043D\u0430 \u0432\u043A\u043B\u0430\u0434\u043A\u0435 \u0421\u0435\u0440\u0432\u0435\u0440. \u0414\u0435\u043B\u0438\u0442\u0435\u0441\u044C \u0438\u043D\u0442\u0435\u0440\u043D\u0435\u0442-IP \u0442\u043E\u043B\u044C\u043A\u043E \u043A\u043E\u0433\u0434\u0430 \u043F\u043E\u0440\u0442\u044B \u0443\u0436\u0435 \u0440\u0430\u0431\u043E\u0442\u0430\u044E\u0442.",
        hint: "\u041F\u0430\u0440\u043E\u043B\u044C \u0437\u0430\u0434\u0430\u0435\u0442\u0441\u044F \u043D\u0430 \u0432\u043A\u043B\u0430\u0434\u043A\u0435 \u0421\u0435\u0440\u0432\u0435\u0440. \u041E\u0442\u043A\u0440\u043E\u0439\u0442\u0435 UDP <strong>2456\u20132458</strong> \u043D\u0430 \u0441\u0432\u043E\u0435\u043C \u043C\u0430\u0440\u0448\u0440\u0443\u0442\u0438\u0437\u0430\u0442\u043E\u0440\u0435 \u0434\u043B\u044F \u0432\u043D\u0435\u0448\u043D\u0435\u0433\u043E \u0434\u043E\u0441\u0442\u0443\u043F\u0430.",
        panelExposureWarning: "\u0423 \u043F\u0430\u043D\u0435\u043B\u0438 (\u043F\u043E\u0440\u0442 <strong>8080</strong>) \u043F\u043E\u043A\u0430 \u043D\u0435\u0442 \u0430\u0443\u0442\u0435\u043D\u0442\u0438\u0444\u0438\u043A\u0430\u0446\u0438\u0438. \u041D\u0435 \u0441\u0442\u043E\u0438\u0442 \u043E\u0442\u043A\u0440\u044B\u0432\u0430\u0442\u044C \u0435\u0451 \u0432 \u0438\u043D\u0442\u0435\u0440\u043D\u0435\u0442 \u2014 \u043B\u044E\u0431\u043E\u0439, \u043A\u0442\u043E \u0443\u0437\u043D\u0430\u0435\u0442 \u0430\u0434\u0440\u0435\u0441, \u0441\u043C\u043E\u0436\u0435\u0442 \u0438\u0437\u043C\u0435\u043D\u0438\u0442\u044C \u043F\u0430\u043D\u0435\u043B\u044C \u0438 \u0441\u0435\u0440\u0432\u0435\u0440."
      },
      players: {
      ...
      quickControls: {
        ...
        save: "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C",
        saved: "\u0417\u0430\u043F\u0440\u043E\u0448\u0435\u043D\u043E \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0438\u0435 \u043C\u0438\u0440\u0430"
      },
      console: {
    ...
    server: {
      settings: {
        ...
        saveAndRestart: "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0438 \u043F\u0435\u0440\u0435\u0437\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u044C",
        envRecreateHint: "\u0418\u043C\u044F, \u043F\u0430\u0440\u043E\u043B\u044C \u0438 \u043F\u0443\u0431\u043B\u0438\u0447\u043D\u044B\u0439 \u0441\u043F\u0438\u0441\u043E\u043A \u043F\u0440\u0438\u043C\u0435\u043D\u044F\u044E\u0442\u0441\u044F \u0432 \u0438\u0433\u0440\u0435 \u0442\u043E\u043B\u044C\u043A\u043E \u043F\u043E\u0441\u043B\u0435 \u043F\u0435\u0440\u0435\u0441\u043E\u0437\u0434\u0430\u043D\u0438\u044F \u043A\u043E\u043D\u0442\u0435\u0439\u043D\u0435\u0440\u0430."
      },
      envFields: {
        SERVER_NAME: {
          label: "\u0418\u043C\u044F \u0441\u0435\u0440\u0432\u0435\u0440\u0430",
        ...
        SERVER_PUBLIC: {
          ...
          hint: "\u0415\u0441\u043B\u0438 \u0432\u043A\u043B\u044E\u0447\u0435\u043D\u043E, \u0441\u0435\u0440\u0432\u0435\u0440 \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0430\u0435\u0442\u0441\u044F \u0432 \u043F\u0443\u0431\u043B\u0438\u0447\u043D\u043E\u043C \u0441\u043F\u0438\u0441\u043A\u0435 Valheim."
        },
        SERVER_ARGS: {
    ...
    mods: {
      ...
      checkAllUpdates: "\u041F\u0440\u043E\u0432\u0435\u0440\u0438\u0442\u044C \u0432\u0441\u0435",
      updateMod: "\u041E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u043C\u043E\u0434",
      updateAllMods: "\u041E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0432\u0441\u0435",
      linkThunderstore: "\u0421\u0441\u044B\u043B\u043A\u0430 \u043D\u0430 Thunderstore",
      dependencyHint: "\u0417\u0430\u0432\u0438\u0441\u0438\u043C\u043E\u0441\u0442\u044C BepInEx \u2014 \u043E\u0431\u043D\u043E\u0432\u043B\u044F\u0439\u0442\u0435 \u0447\u0435\u0440\u0435\u0437 \u043E\u0441\u043D\u043E\u0432\u043D\u043E\u0439 \u043F\u0430\u043A\u0435\u0442 (\u043D\u0430\u043F\u0440. YamlDotNet.dll)",
      ...
      status: {
        ...
        dependency: "\u0417\u0430\u0432\u0438\u0441\u0438\u043C\u043E\u0441\u0442\u044C BepInEx",
    ...
    files: {
      ...
      delete: {
        title: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0444\u0430\u0439\u043B",
        confirm: "\u0412\u044B \u0443\u0432\u0435\u0440\u0435\u043D\u044B, \u0447\u0442\u043E \u0445\u043E\u0442\u0438\u0442\u0435 \u0443\u0434\u0430\u043B\u0438\u0442\u044C {path}?",
        pluginWarning: "\u041F\u043B\u0430\u0433\u0438\u043D {plugin} \u0437\u0430\u0432\u0438\u0441\u0438\u0442 \u043E\u0442 \u044D\u0442\u043E\u0439 \u043A\u043E\u043D\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u0438.",
        recreateWarning: "\u0421\u0435\u0440\u0432\u0435\u0440 \u0437\u0430\u043F\u0443\u0449\u0435\u043D \u2014 BepInEx \u043F\u0435\u0440\u0435\u0441\u043E\u0437\u0434\u0430\u0441\u0442 \u044D\u0442\u043E\u0442 \u0444\u0430\u0439\u043B \u043F\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0435 \u043F\u043B\u0430\u0433\u0438\u043D\u0430.",
        pluginDisabledHint: "\u0421\u0432\u044F\u0437\u0430\u043D\u043D\u044B\u0439 \u043F\u043B\u0430\u0433\u0438\u043D \u043E\u0442\u043A\u043B\u044E\u0447\u0451\u043D \u2014 \u0444\u0430\u0439\u043B \u043D\u0435 \u0431\u0443\u0434\u0435\u0442 \u043F\u0435\u0440\u0435\u0441\u043E\u0437\u0434\u0430\u043D \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438."
      },
      json: {
        beautify: "\u0424\u043E\u0440\u043C\u0430\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C JSON",
        invalid: "\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 JSON \u2014 \u0438\u0441\u043F\u0440\u0430\u0432\u044C\u0442\u0435 \u0441\u0438\u043D\u0442\u0430\u043A\u0441\u0438\u0441 \u043F\u0435\u0440\u0435\u0434 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0438\u0435\u043C"
      }
    },
    logs: {
      docker: "\u0414\u043E\u043A\u0435\u0440",
      ...
      refreshOff: "\u0412\u044B\u043A\u043B.",
      refreshNormal: "\u041E\u0431\u044B\u0447\u043D\u044B\u0439 (5 \u0441)",
      refreshRealtime: "\u0412 \u0440\u0435\u0430\u043B\u044C\u043D\u043E\u043C \u0432\u0440\u0435\u043C\u0435\u043D\u0438 (1 \u0441)",
      refreshOverhead: {
        normal: "~0,5% \u043D\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u043D\u0430 \u043F\u0430\u043D\u0435\u043B\u044C/\u0445\u043E\u0441\u0442 (\u043E\u0446\u0435\u043D\u043A\u0430)",
        realtime: "~2% \u043D\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u043D\u0430 \u043F\u0430\u043D\u0435\u043B\u044C/\u0445\u043E\u0441\u0442 (\u043E\u0446\u0435\u043D\u043A\u0430)"
      },
      searchPlaceholder: "\u041F\u043E\u0438\u0441\u043A \u0432 \u043B\u043E\u0433\u0430\u0445\u2026",
      hideNoise: "\u0421\u043A\u0440\u044B\u0442\u044C \u0448\u0443\u043C",
      clearBuffer: "\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C \u0431\u0443\u0444\u0435\u0440",
      lineCount: "{count} \u0441\u0442\u0440\u043E\u043A \u0432 \u0431\u0443\u0444\u0435\u0440\u0435",
    ...
    about: {
      ...
      serverName: {
        advanced: "\u0420\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u043F\u043E\u043B\u043D\u043E\u0435 \u0438\u043C\u044F \u0441\u0435\u0440\u0432\u0435\u0440\u0430",
        save: "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0438\u043C\u044F"
      },
      credits: {
        valheimDocker: {
    ...
    messages: {
      settings: {
        ...
        desc: "\u041F\u043B\u0430\u043D\u0438\u0440\u0443\u0439\u0442\u0435 \u043E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u044F \u0432 \u0438\u0433\u0440\u0435 \u0447\u0435\u0440\u0435\u0437 RCON (say / showMessage). \u0418\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0435\u0442\u0441\u044F \u0432\u0441\u0442\u0440\u043E\u0435\u043D\u043D\u044B\u0439 \u043C\u043E\u0434 ValheimRcon.",
        enabled: "\u0424\u0443\u043D\u043A\u0446\u0438\u044F \u0432\u043A\u043B\u044E\u0447\u0435\u043D\u0430",
        rconHint: "RCON \u043D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u0435\u043D \u2014 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u044F \u043D\u0435 \u0431\u0443\u0434\u0443\u0442 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u044B, \u043F\u043E\u043A\u0430 ValheimRcon \u043D\u0435 \u0431\u0443\u0434\u0435\u0442 \u0433\u043E\u0442\u043E\u0432 \u0438 \u0441\u0435\u0440\u0432\u0435\u0440 \u043D\u0435 \u0437\u0430\u043F\u0443\u0449\u0435\u043D."
      },
      list: {
        title: "\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u044F",
        create: "\u041D\u043E\u0432\u043E\u0435 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435",
        empty: "\u0410\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438\u0445 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0439 \u043F\u043E\u043A\u0430 \u043D\u0435\u0442.",
        active: "\u0410\u043A\u0442\u0438\u0432\u043D\u043E",
        inactive: "\u0412\u044B\u043A\u043B.",
      ...
      form: {
        createTitle: "\u041D\u043E\u0432\u043E\u0435 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435",
        editTitle: "\u0420\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435",
        defaultName: "\u041E\u0431\u044A\u044F\u0432\u043B\u0435\u043D\u0438\u0435",
        name: "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435",
        channel: "\u041A\u0430\u043D\u0430\u043B",
        trigger: "\u0422\u0440\u0438\u0433\u0433\u0435\u0440",
        interval: "\u0418\u043D\u0442\u0435\u0440\u0432\u0430\u043B",
        intervalSeconds: "\u0421\u0435\u043A\u0443\u043D\u0434\u044B (\u043C\u0438\u043D. 30)",
        runAt: "\u0417\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u044C \u0432",
        dailyTime: "\u0415\u0436\u0435\u0434\u043D\u0435\u0432\u043D\u043E\u0435 \u0432\u0440\u0435\u043C\u044F",
        onlyWhenOnline: "\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u044F\u0442\u044C \u0442\u043E\u043B\u044C\u043A\u043E \u043F\u0440\u0438 \u0438\u0433\u0440\u043E\u043A\u0430\u0445 \u043E\u043D\u043B\u0430\u0439\u043D",
        text: "\u0422\u0435\u043A\u0441\u0442 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u044F",
        textPlaceholder: "\u0414\u043E\u0431\u0440\u043E \u043F\u043E\u0436\u0430\u043B\u043E\u0432\u0430\u0442\u044C \u043D\u0430 %server_name%! \u041E\u043D\u043B\u0430\u0439\u043D: %players_online%",
        tagsHint: "\u041D\u0430\u0436\u043C\u0438\u0442\u0435 \u0442\u0435\u0433, \u0447\u0442\u043E\u0431\u044B \u0432\u0441\u0442\u0430\u0432\u0438\u0442\u044C:",
        preview: "\u041F\u0440\u0435\u0434\u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440",
        previewBtn: "\u041F\u0440\u0435\u0434\u043F\u0440\u043E\u0441\u043C\u043E\u0442\u0440"
      },
      channels: {
        say: "\u0427\u0430\u0442 (say)",
        showMessage: "\u041D\u0430 \u044D\u043A\u0440\u0430\u043D\u0435 (showMessage)"
      },
      triggers: {
        interval: "\u041A\u0430\u0436\u0434\u044B\u0435 X \u0441\u0435\u043A\u0443\u043D\u0434",
        once: "\u041E\u0434\u0438\u043D \u0440\u0430\u0437 \u0432 \u0434\u0430\u0442\u0443/\u0432\u0440\u0435\u043C\u044F",
        daily: "\u0415\u0436\u0435\u0434\u043D\u0435\u0432\u043D\u043E \u0432 \u0443\u043A\u0430\u0437\u0430\u043D\u043D\u043E\u0435 \u0432\u0440\u0435\u043C\u044F",
        on_first_join: "\u041F\u0440\u0438\u0432\u0435\u0442\u0441\u0442\u0432\u0438\u0435 (\u043F\u0435\u0440\u0432\u044B\u0439 \u0432\u0445\u043E\u0434)",
      ...
      summary: {
        interval: "\u041A\u0430\u0436\u0434\u044B\u0435 {seconds}\u0441",
        once: "\u041E\u0434\u0438\u043D \u0440\u0430\u0437 \u0432 {at}",
        daily: "\u0415\u0436\u0435\u0434\u043D\u0435\u0432\u043D\u043E \u0432 {time}",
        on_first_join: "\u041F\u0440\u0438 \u043F\u0435\u0440\u0432\u043E\u043C \u0432\u0445\u043E\u0434\u0435",
        on_join: "\u041F\u0440\u0438 \u043A\u0430\u0436\u0434\u043E\u043C \u0432\u0445\u043E\u0434\u0435"
      },
      confirmDelete: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \xAB{name}\xBB?",
      toasts: {
        settingsSaved: "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u0441\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0439 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u044B",
        created: "\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u0441\u043E\u0437\u0434\u0430\u043D\u043E",
        updated: "\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u043E",
        deleted: "\u0421\u043E\u043E\u0431\u0449\u0435\u043D\u0438\u0435 \u0443\u0434\u0430\u043B\u0435\u043D\u043E",
        sent: "\u041E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E: {text}",
    ...
    mapPage: {
      title: "\u041A\u0430\u0440\u0442\u0430 \u043C\u0438\u0440\u0430",
      noWorld: "\u041D\u0435\u0442 \u0430\u043A\u0442\u0438\u0432\u043D\u043E\u0433\u043E \u043C\u0438\u0440\u0430",
      world: "\u041C\u0438\u0440",
      activeWorld: "\u0430\u043A\u0442\u0438\u0432\u043D\u044B\u0439",
      seed: "\u0421\u0438\u0434",
      empty: "\u041C\u0430\u0440\u043A\u0435\u0440\u044B \u0434\u043B\u044F \u044D\u0442\u043E\u0433\u043E \u043C\u0438\u0440\u0430 \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u044B.",
      emptyPins: "\u041F\u043E\u043A\u0430 \u043D\u0435\u0442 \u043E\u0431\u0449\u0438\u0445 \u043C\u0435\u0442\u043E\u043A.",
      hintNoMod: "\u041D\u0435\u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E: \u0443\u0441\u0442\u0430\u043D\u043E\u0432\u0438\u0442\u0435 ServerSideMap \u0441 \u043E\u0431\u0449\u0438\u043C \u0434\u043E\u0441\u0442\u0443\u043F\u043E\u043C \u043A \u043C\u0435\u0442\u043A\u0430\u043C \u0434\u043B\u044F \u043F\u0438\u043D\u043E\u0432 \u0438 \u043D\u0430\u0441\u0442\u043E\u044F\u0449\u0435\u0433\u043E \u0442\u0443\u043C\u0430\u043D\u0430. \u0411\u0430\u0437\u043E\u0432\u0430\u044F \u043A\u0430\u0440\u0442\u0430 \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u0431\u0435\u0437 \u043C\u043E\u0434\u0430.",
      markers: "\u041C\u0430\u0440\u043A\u0435\u0440\u044B",
      explored: "\u0418\u0441\u0441\u043B\u0435\u0434\u043E\u0432\u0430\u043D\u043E",
      revealAll: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u043F\u043E\u043B\u043D\u043E\u0441\u0442\u044C\u044E \u0438\u0441\u0441\u043B\u0435\u0434\u043E\u0432\u0430\u043D\u043D\u044B\u043C",
      revealAllHint: "\u041E\u0442\u043A\u0440\u044B\u0432\u0430\u0435\u0442 \u0432\u0435\u0441\u044C \u0434\u0438\u0441\u043A \u043A\u0430\u0440\u0442\u044B. \u0412\u044B\u043A\u043B\u044E\u0447\u0435\u043D\u043E \u2014 \u0442\u0443\u043C\u0430\u043D \u0432\u043E\u0439\u043D\u044B \u0438\u0437 ServerSideMap.",
      revealAllHintNoMod: "\u041E\u0442\u043A\u0440\u044B\u0432\u0430\u0435\u0442 \u0431\u0430\u0437\u043E\u0432\u0443\u044E \u043A\u0430\u0440\u0442\u0443 \u043F\u043E \u0441\u0438\u0434\u0443. \u0412\u044B\u043A\u043B\u044E\u0447\u0435\u043D\u043E \u2014 \u0434\u0438\u0441\u043A \u0432 \u0442\u0443\u043C\u0430\u043D\u0435 (ServerSideMap \u043D\u0435 \u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u0435\u043D).",
      serverSideMap: "\xB7 ServerSideMap",
      serverSideMapTag: "ServerSideMap",
      installServerSideMap: "\u0423\u0441\u0442\u0430\u043D\u043E\u0432\u0438\u0442\u044C ServerSideMap",
      openThunderstore: "Thunderstore",
      deletePin: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u043C\u0435\u0442\u043A\u0443",
      deletePinConfirm: '\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u043C\u0435\u0442\u043A\u0443 "{name}" \u0441 \u043E\u0431\u0449\u0435\u0439 \u043A\u0430\u0440\u0442\u044B?',
      deletePinDone: '\u041C\u0435\u0442\u043A\u0430 "{name}" \u0443\u0434\u0430\u043B\u0435\u043D\u0430',
      deletePinNeedsRestart: "\u041F\u0435\u0440\u0435\u0437\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u0435 \u0438\u0433\u0440\u043E\u0432\u043E\u0439 \u0441\u0435\u0440\u0432\u0435\u0440, \u0447\u0442\u043E\u0431\u044B \u043A\u043B\u0438\u0435\u043D\u0442\u044B \u0441\u0438\u043D\u0445\u0440\u043E\u043D\u0438\u0437\u0438\u0440\u043E\u0432\u0430\u043B\u0438 \u043C\u0435\u0442\u043A\u0438.",
      zoomIn: "\u041F\u0440\u0438\u0431\u043B\u0438\u0437\u0438\u0442\u044C",
      zoomOut: "\u041E\u0442\u0434\u0430\u043B\u0438\u0442\u044C",
      zoomReset: "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C \u0432\u0438\u0434",
      zoomResetShort: "\u0421\u0431\u0440\u043E\u0441",
      zoomHint: "\u041A\u043E\u043B\u0451\u0441\u0438\u043A\u043E \u2014 \u0437\u0443\u043C \xB7 \u043F\u0435\u0440\u0435\u0442\u0430\u0441\u043A\u0438\u0432\u0430\u043D\u0438\u0435 \u2014 \u043F\u0430\u043D\u043E\u0440\u0430\u043C\u0430 \xB7 \u0434\u0432\u043E\u0439\u043D\u043E\u0439 \u043A\u043B\u0438\u043A \u2014 \u0441\u0431\u0440\u043E\u0441 \xB7 \u043A\u043B\u0438\u043A \u043F\u043E \u043C\u0435\u0442\u043A\u0435 \u0432 \u0441\u043F\u0438\u0441\u043A\u0435 \u2014 \u0444\u043E\u043A\u0443\u0441"
    },
    metricsPage: {
      ranges: {
        "1h": "1\u0447",
      ...
      memory: "\u041F\u0430\u043C\u044F\u0442\u044C %",
      history: "\u0418\u0441\u0442\u043E\u0440\u0438\u044F",
      noData: "\u041F\u043E\u043A\u0430 \u043D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u2014 \u043E\u0431\u0440\u0430\u0437\u0446\u044B \u043D\u0430\u043A\u0430\u043F\u043B\u0438\u0432\u0430\u044E\u0442\u0441\u044F \u0432\u043E \u0432\u0440\u0435\u043C\u044F \u0440\u0430\u0431\u043E\u0442\u044B \u043F\u0430\u043D\u0435\u043B\u0438.",
      cpuOfLimit: "\u0426\u041F (\u043E\u0442 \u043B\u0438\u043C\u0438\u0442\u0430)",
      aggregate: "\u0421\u0443\u043C\u043C\u0430\u0440\u043D\u043E (\u043F\u0430\u043D\u0435\u043B\u044C+\u0441\u0435\u0440\u0432\u0435\u0440)"
    },
    consolePage: {
      title: "\u041A\u043E\u043D\u0441\u043E\u043B\u044C",
      logs: "\u041B\u043E\u0433\u0438",
      ...
      quick: {
        save: "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C",
        saveShutdown: "\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0438 \u0432\u044B\u043A\u043B\u044E\u0447\u0438\u0442\u044C",
        kick: "\u0412\u044B\u0433\u043D\u0430\u0442\u044C",
        ban: "\u0417\u0430\u0431\u0430\u043D\u0438\u0442\u044C",
    ...
    alerts: {
      title: "Discord",
      subtitle: "\u041F\u043E\u043B\u0443\u0447\u0430\u0439\u0442\u0435 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F Discord \u043E \u0432\u0430\u0436\u043D\u044B\u0445 \u0441\u043E\u0431\u044B\u0442\u0438\u044F\u0445 \u0441\u0435\u0440\u0432\u0435\u0440\u0430.",
      events: "\u0421\u043E\u0431\u044B\u0442\u0438\u044F",
      webhookHint: "\u0412\u0441\u0442\u0430\u0432\u044C\u0442\u0435 URL \u0432\u0435\u0431\u0445\u0443\u043A\u0430 \u0438\u0437 Discord \u203A \u0418\u043D\u0442\u0435\u0433\u0440\u0430\u0446\u0438\u0438 \u203A \u0412\u0435\u0431\u0445\u0443\u043A\u0438.",
      moreChannels: "\u0414\u0440\u0443\u0433\u0438\u0435 \u043A\u0430\u043D\u0430\u043B\u044B (Telegram\u2026)",
      hideMoreChannels: "\u0421\u043A\u0440\u044B\u0442\u044C \u0434\u043E\u043F. \u043A\u0430\u043D\u0430\u043B\u044B",
      serverDown: "\u0421\u0435\u0440\u0432\u0435\u0440 \u0443\u043F\u0430\u043B",
      serverUp: "\u0421\u0435\u0440\u0432\u0435\u0440 \u043E\u043D\u043B\u0430\u0439\u043D",
      serverStarting: "\u0421\u0435\u0440\u0432\u0435\u0440 \u0431\u0443\u0434\u0435\u0442 \u0437\u0430\u043F\u0443\u0449\u0435\u043D",
      serverStopping: "\u0421\u0435\u0440\u0432\u0435\u0440 \u0431\u0443\u0434\u0435\u0442 \u0432\u044B\u043A\u043B\u044E\u0447\u0435\u043D",
      serverRestarting: "\u0421\u0435\u0440\u0432\u0435\u0440 \u0431\u0443\u0434\u0435\u0442 \u043F\u0435\u0440\u0435\u0437\u0430\u043F\u0443\u0449\u0435\u043D",
      serverHighLoad: "\u0421\u0435\u0440\u0432\u0435\u0440 \u043D\u0430 80% \u043D\u0430\u0433\u0440\u0443\u0437\u043A\u0438 (CPU/RAM)",
      playerJoin: "\u0418\u0433\u0440\u043E\u043A \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0438\u043B\u0441\u044F",
      playerLeave: "\u0418\u0433\u0440\u043E\u043A \u0432\u044B\u0448\u0435\u043B",
      playerFirstJoin: "\u041F\u0435\u0440\u0432\u044B\u0439 \u0432\u0445\u043E\u0434 \u0438\u0433\u0440\u043E\u043A\u0430",
      playerKick: "\u041A\u0438\u043A \u0447\u0435\u0440\u0435\u0437 \u043F\u0430\u043D\u0435\u043B\u044C",
      playerBan: "\u0411\u0430\u043D \u0447\u0435\u0440\u0435\u0437 \u043F\u0430\u043D\u0435\u043B\u044C",
      playerDeath: "\u0418\u0433\u0440\u043E\u043A \u043F\u043E\u0433\u0438\u0431",
      playerPvpKill: "\u0418\u0433\u0440\u043E\u043A \u0443\u0431\u0438\u043B \u0438\u0433\u0440\u043E\u043A\u0430 (PvP)",
      bossDefeated: "\u0411\u043E\u0441\u0441 \u043F\u043E\u0431\u0435\u0436\u0434\u0451\u043D",
      raidStarted: "\u0420\u0435\u0439\u0434/\u0441\u043E\u0431\u044B\u0442\u0438\u0435 \u043D\u0430\u0447\u0430\u043B\u043E\u0441\u044C",
      playerChat: "\u0427\u0430\u0442 \u0438\u0433\u0440\u043E\u043A\u0430 \u0441 \u043F\u0440\u0435\u0444\u0438\u043A\u0441\u043E\u043C",
      modAdded: "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D \u043D\u043E\u0432\u044B\u0439 \u043C\u043E\u0434",
      modUpdated: "\u041C\u043E\u0434 \u043E\u0431\u043D\u043E\u0432\u043B\u0451\u043D",
      modRemoved: "\u041C\u043E\u0434 \u0443\u0434\u0430\u043B\u0451\u043D",
      backupScheduledWarning: "\u23F0 \u0417\u0430\u043F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0430\u043D \u0431\u044D\u043A\u0430\u043F",
      backupScheduledWarningHint: "\u0411\u044D\u043A\u0430\u043F \u043C\u0438\u0440\u0430 \u0437\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u0441\u044F \u043F\u0440\u0438\u043C\u0435\u0440\u043D\u043E \u0447\u0435\u0440\u0435\u0437 5 \u043C\u0438\u043D.",
      restartScheduledWarning: "\u23F0 \u0417\u0430\u043F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0430\u043D \u043F\u0435\u0440\u0435\u0437\u0430\u043F\u0443\u0441\u043A",
      restartScheduledWarningHint: "\u0417\u0430\u043F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u044B\u0439 \u043F\u0435\u0440\u0435\u0437\u0430\u043F\u0443\u0441\u043A \u0441\u0435\u0440\u0432\u0435\u0440\u0430 \u0447\u0435\u0440\u0435\u0437 ~5 \u043C\u0438\u043D.",
      backupOk: "\u0411\u044D\u043A\u0430\u043F \u0443\u0441\u043F\u0435\u0448\u0435\u043D",
      backupFail: "\u041E\u0448\u0438\u0431\u043A\u0430 \u0431\u044D\u043A\u0430\u043F\u0430",
      chatBridge: "\u041C\u043E\u0441\u0442 \u0447\u0430\u0442\u0430 (\u0438\u0433\u0440\u0430 \u2192 Discord)",
      chatPrefix: "\u041F\u0440\u0435\u0444\u0438\u043A\u0441",
      chatPrefixPlaceholder: "@discord",
      chatBridgeHint: "\u0418\u0433\u0440\u043E\u043A\u0438 \u043F\u0438\u0448\u0443\u0442 \u043F\u0440\u0435\u0444\u0438\u043A\u0441 \u0432 \u0447\u0430\u0442\u0435 (\u043D\u0430\u043F\u0440. @discord \u043F\u0440\u0438\u0432\u0435\u0442), \u0447\u0442\u043E\u0431\u044B \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u043E\u0441\u0442\u0430\u043B\u044C\u043D\u043E\u0435 \u0432 Discord \u043E\u0442 \u0441\u0432\u043E\u0435\u0433\u043E \u0438\u043C\u0435\u043D\u0438. \u0427\u0430\u0442 \u0434\u043E\u043B\u0436\u0435\u043D \u043F\u043E\u044F\u0432\u043B\u044F\u0442\u044C\u0441\u044F \u0432 \u043B\u043E\u0433\u0430\u0445 \u0441\u0435\u0440\u0432\u0435\u0440\u0430/BepInEx.",
      discord: "Discord",
      telegram: "Telegram",
      webhookPlaceholder: "URL \u0432\u0435\u0431\u0445\u0443\u043A\u0430 Discord",
      botTokenPlaceholder: "\u0422\u043E\u043A\u0435\u043D \u0431\u043E\u0442\u0430 Telegram",
      chatIdPlaceholder: "Chat ID Telegram",
      secretSet: "\u2022\u2022\u2022\u2022\u2022\u2022 (\u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u043E)",
      showSecret: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C",
      hideSecret: "\u0421\u043A\u0440\u044B\u0442\u044C",
      test: "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0442\u0435\u0441\u0442",
      saved: "\u041E\u043F\u043E\u0432\u0435\u0449\u0435\u043D\u0438\u044F \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u044B",
      tested: "\u0422\u0435\u0441\u0442\u043E\u0432\u043E\u0435 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E",
      testFailed: "\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0442\u0435\u0441\u0442\u043E\u0432\u043E\u0435 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u0435"
    },
    schedule: {
      title: "\u0420\u0430\u0441\u043F\u0438\u0441\u0430\u043D\u0438\u0435",
      subtitle: "\u0410\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438\u0435 \u0437\u0430\u0434\u0430\u0447\u0438 \u0432 \u0441\u0442\u0438\u043B\u0435 cron.",
      jobs: {
        restart: "\u041D\u043E\u0447\u043D\u043E\u0439 \u043F\u0435\u0440\u0435\u0437\u0430\u043F\u0443\u0441\u043A",
        backup: "\u0410\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438\u0439 \u0431\u044D\u043A\u0430\u043F",
        modUpdate: "\u041E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u0435 \u043C\u043E\u0434\u043E\u0432"
      },
      saved: "\u0420\u0430\u0441\u043F\u0438\u0441\u0430\u043D\u0438\u0435 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u043E",
      lastRun: "\u041F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0439 \u0437\u0430\u043F\u0443\u0441\u043A: {when} ({status})",
      neverRun: "\u0415\u0449\u0451 \u043D\u0435 \u0437\u0430\u043F\u0443\u0441\u043A\u0430\u043B\u043E\u0441\u044C",
      cronHint: "\u0424\u043E\u0440\u043C\u0430\u0442 cron: \u043C\u0438\u043D\u0443\u0442\u0430 \u0447\u0430\u0441 \u0434\u0435\u043D\u044C \u043C\u0435\u0441\u044F\u0446 \u0434\u0435\u043D\u044C-\u043D\u0435\u0434\u0435\u043B\u0438 (\u043D\u0430\u043F\u0440. 0 5 * * * = \u0435\u0436\u0435\u0434\u043D\u0435\u0432\u043D\u043E \u0432 05:00)."
    }
  };
  ...
  var es_ES_default = {
    ...
    common: {
      ...
      toasts: {
        ...
        checkRequested: "Cheque solicitado",
        modsCheckAllSummary: "Comprobados {checked} paquete(s): {updates} actualizaci\xF3n(es) disponible(s), {errors} error(es)",
        modsUpdateAllSummary: "Actualizados {updated} paquete(s), {failed} fallidos, {skipped} ya actualizados",
        modsNoLinkedPackages: "Ning\xFAn mod vinculado a Thunderstore"
      },
      confirm: {
        ...
        updateAllMods: "\xBFActualizar todos los paquetes siguientes? Es posible que sea necesario reiniciar el servidor.\n\n{packages}",
    ...
    help: {
      categories: {
        ...
        discord: {
          label: "Alertas de Discord",
          items: [
            {
              q: "\xBFC\xF3mo activo notificaciones de Discord?",
              a: "Abre la pesta\xF1a <b>Discord</b> en la barra lateral. Crea un webhook en Discord (canal \u2192 Integraciones \u2192 Webhooks), pega la URL, activa Discord, elige eventos, luego <b>Guardar</b> y <b>Enviar prueba</b>. Gu\xEDa: <code>docs/discord-alerts.md</code>."
            },
            {
              q: "\xBFPor qu\xE9 una alerta de entrada mostr\xF3 un Steam ID?",
              a: "Valheim registra primero el Steam ID; el nombre del personaje aparece unos segundos despu\xE9s. El panel espera un poco y guarda el nombre en cach\xE9 para la pr\xF3xima entrada."
            },
            {
              q: "\xBFQu\xE9 eventos puedo activar?",
              a: "Servidor cae/sube, inicia/apaga/reinicia, 80% CPU/RAM, jugador entra/sale, mod nuevo e fallo de copia de seguridad."
            }
          ]
        },
        problemas: {
    ...
    dashboard: {
      ...
      connect: {
        ...
        localIp: "IP local",
        localIpHint: "Misma red Wi\u2011Fi/LAN \u2014 quien est\xE1 en casa usa este.",
        internetIp: "IP de Internet",
        internetIpHint: "Amigos fuera de tu red \u2014 hay que abrir puertos UDP.",
        portGuideTitle: "C\xF3mo abrir puertos para jugar por Internet",
        portGuideLinux: 'En Linux, permita el firewall: <code class="text-gray-300">sudo ufw allow 2456:2458/udp &amp;&amp; sudo ufw reload</code>',
        portGuideRouter: 'En el router, cree <strong class="text-gray-300">Port Forwarding</strong> / Virtual Server / redirecci\xF3n de puertos: UDP <strong class="text-gray-300">2456\u20132458</strong> \u2192 la direcci\xF3n local de arriba.',
        portGuideSearch: 'Busque en Google: <strong class="text-gray-300">port forwarding [marca/modelo del router]</strong> o <strong class="text-gray-300">abrir puerto UDP [marca del router]</strong> \u2014 cada marca usa un men\xFA distinto.',
        portGuidePassword: "La contrase\xF1a del servidor est\xE1 en la pesta\xF1a Servidor. Comparta el IP de Internet solo cuando los puertos funcionen.",
        ...
        panelExposureWarning: "El panel (puerto <strong>8080</strong>) a\xFAn no tiene autenticaci\xF3n. No es ideal exponerlo a Internet: cualquiera que descubra la direcci\xF3n podr\xEDa alterar el panel y el servidor."
      },
      players: {
      ...
      quickControls: {
        ...
        save: "Guardar",
        saved: "Guardado de mundo solicitado"
      },
      console: {
      ...
      cpuHost: "{host}% del host",
      cpuTrend: "Tendencia de CPU",
      openMetrics: "Abrir M\xE9tricas \u2192"
    },
    server: {
      settings: {
        ...
        saveAndRestart: "Guardar y reiniciar",
        envRecreateHint: "Nombre, contrase\xF1a y listado p\xFAblico requieren recrear el contenedor para aplicarse en el juego."
      },
      envFields: {
        SERVER_NAME: {
        ...
        SERVER_PUBLIC: {
          label: "Listado p\xFAblico",
          hint: "Cuando est\xE1 activado, el servidor aparece en la lista p\xFAblica de Valheim."
        },
        SERVER_ARGS: {
    ...
    mods: {
      ...
      viewList: "Lista",
      list: {
        updateStatus: "Estado de actualizaci\xF3n"
      },
      install: {
        title: "Instalar mod",
      ...
      checkAllUpdates: "Comprobar todos",
      updateMod: "Actualizar mod",
      updateAllMods: "Actualizar todos",
      linkThunderstore: "Enlace Thunderstore",
      dependencyHint: "Dependencia de BepInEx \u2014 actualizar mediante el paquete principal (ej. YamlDotNet.dll)",
      ...
      status: {
        ...
        dependency: "Dependencia BepInEx",
    ...
    files: {
      ...
      delete: {
        ...
        confirm: "\xBFSeguro que desea eliminar {path}?",
        pluginWarning: "El plugin {plugin} depende de esta configuraci\xF3n.",
        recreateWarning: "El servidor est\xE1 en ejecuci\xF3n \u2014 BepInEx recrear\xE1 este archivo cuando el plugin cargue.",
        pluginDisabledHint: "El plugin vinculado est\xE1 desactivado; el archivo no se recrear\xE1 autom\xE1ticamente."
      },
      json: {
        beautify: "Formatear JSON",
        invalid: "JSON inv\xE1lido \u2014 corrija la sintaxis antes de guardar"
      }
    },
    logs: {
      docker: "Docker",
      bepinex: "BepInEx",
      autoRefresh: "Autom\xE1tico (5s)",
      refreshLabel: "Actualizaci\xF3n autom\xE1tica",
      refreshOff: "Apagado",
      refreshNormal: "Normal (5s)",
      refreshRealtime: "Tiempo real (1s)",
      refreshOverhead: {
        normal: "~0,5% de overhead en panel/host (est.)",
        realtime: "~2% de overhead en panel/host (est.)"
      },
      searchPlaceholder: "Buscar en logs\u2026",
      hideNoise: "Ocultar ruido",
      clearBuffer: "Limpiar buffer",
      lineCount: "{count} l\xEDneas en buffer",
    ...
    about: {
      ...
      serverName: {
        advanced: "Editar nombre completo del servidor",
        save: "Guardar nombre"
      },
      credits: {
        valheimDocker: {
    ...
    messages: {
      settings: {
        title: "Mensajes autom\xE1ticos",
        desc: "Programa anuncios en el juego v\xEDa RCON (say / showMessage). Usa el mod ValheimRcon incluido.",
        enabled: "Funci\xF3n activa",
        rconHint: "RCON no disponible \u2014 los mensajes no se enviar\xE1n hasta que ValheimRcon est\xE9 listo y el servidor en marcha."
      },
      list: {
        title: "Mensajes",
        create: "Nuevo mensaje",
        empty: "A\xFAn no hay mensajes autom\xE1ticos.",
        active: "Activo",
        inactive: "Apagado",
      ...
      form: {
        ...
        onlyWhenOnline: "Enviar solo con jugadores en l\xEDnea",
        text: "Texto del mensaje",
        textPlaceholder: "\xA1Bienvenido a %server_name%! En l\xEDnea: %players_online%",
        tagsHint: "Haz clic en una etiqueta para insertar:",
        preview: "Vista previa",
        previewBtn: "Vista previa"
      },
      channels: {
        say: "Chat (say)",
        showMessage: "En pantalla (showMessage)"
      },
      triggers: {
        interval: "Cada X segundos",
        once: "Una vez en fecha/hora",
        daily: "Cada d\xEDa a la hora",
        on_first_join: "Bienvenida (primer join)",
        on_join: "Cada entrada de jugador"
      },
      intervalPresets: {
        "60": "Cada 1 minuto",
        "300": "Cada 5 minutos",
      ...
      summary: {
        interval: "Cada {seconds}s",
        once: "Una vez en {at}",
        daily: "Diario a las {time}",
        on_first_join: "En el primer join",
        on_join: "En cada entrada"
      },
      confirmDelete: '\xBFEliminar el mensaje "{name}"?',
      toasts: {
        settingsSaved: "Ajustes de mensajes guardados",
        created: "Mensaje creado",
        updated: "Mensaje actualizado",
        deleted: "Mensaje eliminado",
        sent: "Enviado: {text}",
        textRequired: "El texto del mensaje es obligatorio"
      }
    },
    theme: {
      dark: "Tema oscuro",
    ...
    mapPage: {
      ...
      noWorld: "Sin mundo activo",
      world: "Mundo",
      activeWorld: "activo",
      seed: "Semilla",
      empty: "No se encontraron marcadores para este mundo.",
      emptyPins: "A\xFAn no hay pines compartidos.",
      hintNoMod: "Opcional: instala ServerSideMap con intercambio de marcadores para pines y niebla reales. El mapa base funciona sin el mod.",
      markers: "Marcadores",
      explored: "Explorado",
      revealAll: "Mostrar totalmente explorado",
      revealAllHint: "Revela el disco completo del mapa. Desactivado mantiene la niebla de ServerSideMap.",
      revealAllHintNoMod: "Revela el mapa base te\xF1ido por la seed. Desactivado mantiene el disco con niebla (ServerSideMap no es obligatorio).",
      serverSideMap: "\xB7 ServerSideMap",
      serverSideMapTag: "ServerSideMap",
      installServerSideMap: "Instalar ServerSideMap",
      openThunderstore: "Thunderstore",
      deletePin: "Eliminar pin",
      deletePinConfirm: '\xBFEliminar el pin "{name}" del mapa compartido?',
      deletePinDone: 'Pin "{name}" eliminado',
      deletePinNeedsRestart: "Reinicia el servidor del juego para que los clientes sincronicen los pines.",
      zoomIn: "Acercar",
      zoomOut: "Alejar",
      zoomReset: "Restablecer vista",
      zoomResetShort: "Reset",
      zoomHint: "Scroll para zoom \xB7 arrastra para mover \xB7 doble clic para restablecer \xB7 clic en un pin de la lista para enfocar"
    },
    metricsPage: {
      ranges: {
        "1h": "1h",
      ...
      memory: "Memoria %",
      history: "Historial",
      noData: "A\xFAn sin datos \u2014 las muestras se acumulan mientras el panel funciona.",
      cpuOfLimit: "CPU (del l\xEDmite)",
      aggregate: "Agregado (panel+servidor)"
    },
    consolePage: {
      title: "Consola",
      logs: "Registros",
    ...
    alerts: {
      title: "Discord",
      subtitle: "Recibe notificaciones de Discord sobre eventos importantes del servidor.",
      events: "Eventos",
      webhookHint: "Pega la URL del webhook en Discord \u203A Integraciones \u203A Webhooks.",
      moreChannels: "M\xE1s canales (Telegram\u2026)",
      hideMoreChannels: "Ocultar canales extra",
      serverDown: "El servidor cae",
      serverUp: "Servidor en l\xEDnea",
      serverStarting: "El servidor se iniciar\xE1",
      serverStopping: "El servidor se apagar\xE1",
      serverRestarting: "El servidor se reiniciar\xE1",
      serverHighLoad: "Servidor al 80% de carga (CPU/RAM)",
      playerJoin: "Un jugador entra",
      playerLeave: "Un jugador sale",
      playerFirstJoin: "Primer join de jugador nuevo",
      playerKick: "Kick desde el panel",
      playerBan: "Ban desde el panel",
      playerDeath: "Jugador muri\xF3",
      playerPvpKill: "Jugador mat\xF3 a jugador (PvP)",
      bossDefeated: "Jefe derrotado",
      raidStarted: "Raid/evento iniciado",
      playerChat: "Chat del jugador con prefijo",
      modAdded: "Nuevo mod a\xF1adido",
      modUpdated: "Mod actualizado",
      modRemoved: "Mod eliminado",
      backupScheduledWarning: "\u23F0 Backup programado",
      backupScheduledWarningHint: "El backup del mundo se ejecutar\xE1 en unos 5 minuto(s).",
      restartScheduledWarning: "\u23F0 Reinicio programado",
      restartScheduledWarningHint: "El reinicio programado del servidor se ejecutar\xE1 en unos 5 minuto(s).",
      backupOk: "Copia exitosa",
      backupFail: "Falla la copia",
      chatBridge: "Puente de chat (juego \u2192 Discord)",
      chatPrefix: "Prefijo",
      chatPrefixPlaceholder: "@discord",
      chatBridgeHint: "Los jugadores escriben el prefijo en el chat (p. ej. @discord hola) para enviar el resto a Discord con su nombre. El chat debe aparecer en los logs del servidor/BepInEx.",
      discord: "Discord",
      telegram: "Telegram",
      webhookPlaceholder: "URL del webhook de Discord",
      botTokenPlaceholder: "Token del bot de Telegram",
      chatIdPlaceholder: "Chat ID de Telegram",
      secretSet: "\u2022\u2022\u2022\u2022\u2022\u2022 (guardado)",
      showSecret: "Mostrar",
      hideSecret: "Ocultar",
      test: "Enviar prueba",
      saved: "Alertas guardadas",
      tested: "Notificaci\xF3n de prueba enviada",
      testFailed: "Fall\xF3 la notificaci\xF3n de prueba"
    },
    schedule: {
      title: "Programaci\xF3n",
      subtitle: "Tareas autom\xE1ticas tipo cron.",
      jobs: {
        restart: "Reinicio nocturno",
        backup: "Copia autom\xE1tica",
        modUpdate: "Actualizaci\xF3n de mods"
      },
      saved: "Programaci\xF3n guardada",
      lastRun: "\xDAltima ejecuci\xF3n: {when} ({status})",
      neverRun: "Nunca ejecutado",
      cronHint: "Formato cron: minuto hora d\xEDa mes d\xEDa-semana (p. ej. 0 5 * * * = diario a las 05:00)."
    }
  };
  ...
  function lookup(messages2, key) {
    if (!messages2 || !key) return void 0;
  ...
  // frontend/js/log-filters.js
  var DOCKER_TS = /^\[[A-Za-z]{3}\s+\d{1,2}\s+\d{2}:\d{2}:\d{2}\]\s*/;
  var BEPINEX_BRACKET = /^\[(?:Info|Warning|Error|Message|Debug|Log)\s*:\s*[^\]]+\]\s*/i;
  var VALHEIM_CHAT = /(\d+)\/([^\s(]+)\s*\([^)]+\):\s*(say|showMessage|shout|talk)\s+(.+)$/i;
  var NOISE_PATTERNS = [
  ...
  function parseGameChatLine(line) {
  ...
  function mergeLogBuffer(buffer, incoming, maxSize = 5e3) {
  ...
  var helpers = {
    ...
    formatLogLine(line, search) {
      ...
      if (legacy) {
        const msgCls2 = chat ? "log-chat" : this.logMessageClass(legacy[3]);
        const body2 = chat ? `${chat.player}: ${chat.message} (${chat.channel})` : legacy[3];
        return `<span class="log-ts">${this.escapeHtml(legacy[1])}</span> <span class="log-msg ${msgCls2}">${this.highlightSearch(body2, search)}</span>`;
      }
      const match = line.match(/^(\[[^\]]+\])\s+(.*)$/);
      if (match) {
        const msgCls2 = chat ? "log-chat" : this.logMessageClass(match[2]);
        const body2 = chat ? `${chat.player}: ${chat.message} (${chat.channel})` : match[2];
        return `<span class="log-ts">${this.escapeHtml(match[1])}</span> <span class="log-msg ${msgCls2}">${this.highlightSearch(body2, search)}</span>`;
      }
    ...
    formatLogHtml(text, emptyLabel, search) {
      ...
      return lines.map((line) => `<span class="log-line">${this.formatLogLine(line, search)}</span>`).join("\n");
    },
    formatSize(bytes) {
      if (!bytes) return "0 B";
  ...
  var CONFIG_PAGES = ["server", "worlds", "messages", "schedule", "files", "audit", "help", "about", "donation"];
  var nav = {
    navPrimary: [
    ...
    configTabTitle() {
      void this.localeVersion;
      return this.configTabs.find((i) => i.id === this.page)?.labelKey ? this.t(this.configTabs.find((i) => i.id === this.page).labelKey) : "";
    },
    goToPage(id) {
      if (id === "config") {
    ...
    async playerAction(steamId, name, action) {
      ...
      return this.withBusy(`playerAction:${sid}:${action}`, async () => {
        try {
          ...
          this.toast(messages2[action] || this.t("common.toasts.actionCompleted"));
          if (data.synced) {
    ...
    async serverAction(action) {
      return this.withBusy(`server:${action}`, async () => {
        try {
          ...
          const toastKey = action === "recreate" ? "common.toasts.configSavedRecreated" : "common.toasts.serverActionCompleted";
  ...
  // frontend/js/server_name_colors.js
  var SERVER_NAME_FORBIDDEN_CHARS_RE = /["<>]/;
  var SERVER_NAME_NAMED_COLORS = [
    "red",
    "green",
    "blue",
    "yellow",
  ...
  var SERVER_NAME_HEX_PRESETS = ["#FFD700", "#FF6600", "#FFFFFF"];
  var SERVER_NAME_COLOR_OPTIONS = [
  ...
  var ALLOWED_COLORS = /* @__PURE__ */ new Set([
    ...SERVER_NAME_NAMED_COLORS,
    ...SERVER_NAME_HEX_PRESETS.map((h) => h.toUpperCase())
  ]);
  var COLOR_TAG_RE = /<color=([^>]+)>([\s\S]*?)(?:<\/color>|(?=<color=)|$)/gi;
  var HEX_SHORT_RE = /<#([0-9A-Fa-f]{3,8})>([\s\S]*?)(?=<#|$)/g;
  function sanitizeServerNameFragment(text) {
  ...
  function isAllowedServerNameColor(color) {
  ...
  function stripColorTags(name) {
    return String(name || "").replace(COLOR_TAG_RE, "$2").replace(HEX_SHORT_RE, "$2").replace(/<\/?color[^>]*>/gi, "").replace(/<#[0-9A-Fa-f]{3,8}>/gi, "");
  }
  ...
  function parseColoredServerName(raw) {
    const text = String(raw || "");
  ...
  function emptyColorPart() {
    return { text: "", color: "" };
  }
  function findHexPartIndex(parts) {
    return (parts || []).findIndex((p) => isHexColor(normalizeColorValue(p.color)));
  }
  function buildColoredServerName(parts) {
  ...
  function validateColoredServerName(parts) {
    const slots = (parts || []).filter((p) => String(p?.text ?? "").length);
    const colors = slots.map((p) => normalizeColorValue(p.color)).filter(Boolean);
  ...
  function previewColoredServerName(parts, { suffix = "" } = {}) {
    const slots = Array.isArray(parts) ? parts : [];
    let html = "";
    for (const slot of slots) {
      const text = sanitizeServerNameFragment(slot?.text ?? "");
      ...
      html += css ? `<span style="color:${css}">${safe}</span>` : safe;
    }
    if (suffix) {
      html += `<span class="text-gray-500">${suffix.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;")}</span>`;
    }
    return html || '<span class="text-gray-600">\u2014</span>';
  }

  // frontend/js/state/server.js
  var ENV_FIELD_KEYS = ["SERVER_ARGS"];
  var LIST_KEYS = ["admin", "banned", "permitted"];
  var DEFAULT_SERVER_NAME_META = {
    branding_enabled: true,
    suffix: " - Powered by VKP",
    effective_name: ""
  };
  var EMPTY_COLOR_PARTS = () => [emptyColorPart()];
  var server = {
    envValues: {},
    ...
    serverNameDistinctColors() {
      return [...new Set(
        this.serverNameColorParts.map((p) => normalizeColorValue(p.color)).filter(Boolean)
      )];
    },
    ...
    onServerNameBrandingToggle() {
      const suffix = this.serverNameMeta.suffix || DEFAULT_SERVER_NAME_META.suffix;
      if (this.showServerNameBranding) {
        const effective = this.serverNameMeta.effective_name || (this.serverNameBase ? `${this.serverNameBase}${suffix}` : "");
    ...
    syncServerNameFromEnv(data) {
      ...
      if (this.serverNameMeta.branding_enabled) {
        this.envValues.SERVER_NAME = this.serverNameMeta.effective_name || (this.serverNameBase ? `${this.serverNameBase}${suffix}` : "");
      } else {
  ...
  var CONFIG_EXTS = /* @__PURE__ */ new Set([".cfg", ".ini", ".json", ".yaml", ".yml", ".xml", ".prefs", ".env"]);
  ...
  var FILE_TYPE_FILTER_IDS = ["", "config", "dll", "plugin", "world", "json", "list", "backup", "log"];
  ...
  var files = {
    ...
    classifyFileItem(item) {
      ...
      const isWorldBackup = name.includes("_backup") || name.endsWith(".bak") || path.includes("/backups/");
    ...
    renderTreeItem(item, depth) {
      ...
      if (item.type === "dir") {
        ...
        let html = `<button type="button" class="file-tree-row file-tree-folder" data-path="${this.escapeHtml(item.path)}" style="--file-depth:${pad}px"><span class="${chevronCls}">${loading ? '<span class="spinner spinner-xs"></span>' : CHEVRON_SVG}</span><span class="file-tree-icon file-tree-icon-folder">${FOLDER_SVG}</span><span class="file-tree-name">${name}</span></button>`;
        if (expanded) {
  ...
  var LOG_REFRESH_STORAGE_KEY = "vikinger-log-refresh-mode";
  var LOG_REFRESH_INTERVALS = {
    normal: 5e3,
    realtime: 1e3
  };
  ...
  var logs = {
    ...
    logRefreshOverheadHint() {
      ...
      const key = this.logRefreshMode === "realtime" ? "logs.refreshOverhead.realtime" : "logs.refreshOverhead.normal";
      return this.t(key);
    },
    initLogRefresh() {
  ...
  // frontend/js/state/pagination.js
  var PAGINATION_PAGE_SIZES = [10, 25, 50];
  var pagination = {
  ...
  // frontend/js/state/theme.js
  var THEME_KEY = "vikinger-panel-theme";
  var theme = {
    theme: "dark",
    initTheme() {
      let stored = null;
  ...
  var metricsPage = {
    ...
    renderHistChart() {
      ...
      const labels = rows.map(
        (s) => new Date((s.ts || 0) * 1e3).toLocaleTimeString(this.locale || "en-US", {
          hour: "2-digit",
          minute: "2-digit"
        })
      );
  ...
  var MAP_REVEAL_KEY = "vikinger.mapRevealAll";
  var MAP_ZOOM_MIN = 0.6;
  var MAP_ZOOM_MAX = 12;
  var MAP_ZOOM_STEP = 1.2;
  var SERVERSIDEMAP_TS_URL = "https://thunderstore.io/c/valheim/p/Mydayyy/ServerSideMap/";
  ...
  var mapPage = {
    ...
    _mapPanStartY: 0,
    defaultMapWorld() {
      return this.status?.running_world_name || this.status?.config?.world_name || this.mapActiveWorld || this.mapWorldOptions[0] || "";
    },
    ...
    mapFogUrl() {
      ...
      const base = this.mapData?.explored?.image_url || (world ? `/api/map/${encodeURIComponent(world)}/fog.png` : "");
      if (!base) return "";
    ...
    markerNorm(mk) {
      ...
      const minX = b.min_x != null ? b.min_x : -1e4;
      const maxX = b.max_x != null ? b.max_x : 1e4;
      const minZ = b.min_z != null ? b.min_z : -1e4;
      const maxZ = b.max_z != null ? b.max_z : 1e4;
      ...
      return this.withBusy(`deleteMapPin:${mk.index}`, async () => {
        try {
          ...
          this.mapData = {
            ...
            explored: data.explored ? { ...this.mapData.explored || {}, ...data.explored } : this.mapData.explored
          };
  ...
  // frontend/js/state/alerts.js
  var ALERT_EVENT_DEFS = [
    ...
    { id: "player_first_join", labelKey: "alerts.playerFirstJoin" },
    { id: "player_kick", labelKey: "alerts.playerKick" },
    { id: "player_ban", labelKey: "alerts.playerBan" },
    { id: "player_death", labelKey: "alerts.playerDeath" },
    { id: "player_pvp_kill", labelKey: "alerts.playerPvpKill" },
    { id: "boss_defeated", labelKey: "alerts.bossDefeated" },
    { id: "raid_started", labelKey: "alerts.raidStarted" },
  ...
  var DEFAULT_EVENTS = Object.fromEntries(ALERT_EVENT_DEFS.map((e) => [e.id, false]));
  var DEFAULT_CHAT_BRIDGE = { enabled: false, prefix: "@discord" };
  var alerts = {
    alertsConfig: {
  ...
  var schedule = {
    ...
    jobStatusLabel(jobId) {
      ...
      if (!st) return "";
      if (st.last_run) {
        const when = new Date(st.last_run * 1e3).toLocaleString(this.locale || "en-US");
